...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append triangle_before_ast_to_cfg_prog.constants_vdecls triangle_before_ast_to_cfg_prog.globals_vdecls),(append triangle_passive_prog.params_vdecls triangle_passive_prog.locals_vdecls)) \<Gamma> [] triangle_passive_prog.proc_body ((Inl 6),(Normal n_s)) (m',s'))" and 
...
Axioms: "(axiom_assm A \<Gamma> triangle_before_ast_to_cfg_prog.constants_vdecls (n_s::(('a)nstate)) triangle_before_ast_to_cfg_prog.axioms)" and 
...
ConstsGlobal: "(state_typ_wf A [] (global_state n_s) (append triangle_before_ast_to_cfg_prog.constants_vdecls triangle_before_ast_to_cfg_prog.globals_vdecls))"
shows "(s' \<noteq> Failure)"
proof -
let ?n_s_c = "(nstate_global_restriction n_s triangle_before_ast_to_cfg_prog.constants_vdecls)"
let ?\<Lambda> = "((append triangle_before_ast_to_cfg_prog.constants_vdecls triangle_before_ast_to_cfg_prog.globals_vdecls),(append triangle_passive_prog.params_vdecls triangle_passive_prog.locals_vdecls))"
let ?\<Lambda>c = "((triangle_before_ast_to_cfg_prog.constants_vdecls,[])::(var_context))"
