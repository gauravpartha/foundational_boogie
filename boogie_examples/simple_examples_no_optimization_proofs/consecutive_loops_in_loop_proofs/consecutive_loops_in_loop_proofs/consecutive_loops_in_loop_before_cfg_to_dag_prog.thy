theory consecutive_loops_in_loop_before_cfg_to_dag_prog
...
definition block_2
  where
    "block_2  = [(Assume (BinOp (Var 1) Gt (Lit (LInt 0))))]"
definition block_3
  where
    "block_3  = []"
definition block_4
...
shows "(((map fst (append consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls)))) \<le> 0))"
unfolding consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls_def consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
unfolding consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls_def consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls_def
by simp

lemma locals_min:
shows "(\<forall> x. ((Set.member x (set (map fst (append consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls)))) \<longrightarrow> (x \<ge> 0)))"
using locals_min_aux helper_min
by blast

lemma globals_locals_disj:
shows "((Set.inter (set (map fst (append consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls))) (set (map fst (append consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls)))) = {})"
unfolding consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls_def consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls_def
by simp
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls) )"
unfolding consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls) )"
unfolding consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma params_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls) )"
unfolding consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls_def
by simp

lemma locals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls) )"
unfolding consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls_def
by simp

lemma var_context_wf:
shows "(\<forall> x \<tau>. (((lookup_var_ty ((append consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls),(append consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls)) x) = (Some \<tau>)) \<longrightarrow> ((wf_ty 0) \<tau>)))"
apply (rule lookup_ty_pred_2)
by ((simp_all add:consts_wf globals_wf params_wf locals_wf))

lemma m_x:
shows "((map_of (append consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls) 0) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_y:
shows "((map_of (append consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls) 1) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma l_x:
shows "((lookup_var_decl ((append consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls),(append consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls)) 0) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append consecutive_loops_in_loop_before_cfg_to_dag_prog.constants_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.globals_vdecls),(append consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls)) 0) = (Some (TPrim TInt)))"
...
definition proc :: "(mbodyCFG procedure)"
  where
    "proc  = (|proc_ty_args = 0,proc_args = consecutive_loops_in_loop_before_cfg_to_dag_prog.params_vdecls,proc_rets = [],proc_modifs = [],proc_pres = (exprs_to_only_checked_spec consecutive_loops_in_loop_before_cfg_to_dag_prog.pres),proc_posts = (exprs_to_only_checked_spec consecutive_loops_in_loop_before_cfg_to_dag_prog.post),proc_body = (Some (consecutive_loops_in_loop_before_cfg_to_dag_prog.locals_vdecls,consecutive_loops_in_loop_before_cfg_to_dag_prog.proc_body))|)"
