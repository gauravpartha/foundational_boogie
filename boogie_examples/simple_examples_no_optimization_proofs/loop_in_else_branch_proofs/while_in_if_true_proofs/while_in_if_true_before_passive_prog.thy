...
definition block_1
  where
    "block_1  = [(Assert (BinOp (Var 0) Lt (Lit (LInt 0))))]"
definition block_2
  where
...
definition block_4
  where
    "block_4  = [(Assume (BinOp (Var 1) Gt (Lit (LInt 0)))),(Assign 1 (BinOp (Var 1) Sub (Lit (LInt 1)))),(Assume (Lit (LBool False)))]"
definition block_5
  where
    "block_5  = [(Havoc 1)]"
definition block_6
  where
    "block_6  = [(Assume (BinOp (Lit (LInt 0)) Ge (Var 0))),(Assign 0 (BinOp (Var 0) Sub (Lit (LInt 1))))]"
definition block_7
  where
