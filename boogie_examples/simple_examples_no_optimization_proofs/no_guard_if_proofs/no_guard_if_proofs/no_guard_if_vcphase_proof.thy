...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append no_guard_if_before_ast_to_cfg_prog.constants_vdecls no_guard_if_before_ast_to_cfg_prog.globals_vdecls),(append no_guard_if_passive_prog.params_vdecls no_guard_if_passive_prog.locals_vdecls)) \<Gamma> [] no_guard_if_passive_prog.proc_body ((Inl 5),(Normal n_s)) (m',s'))" and 
...
Axioms: "(axiom_assm A \<Gamma> no_guard_if_before_ast_to_cfg_prog.constants_vdecls (n_s::(('a)nstate)) no_guard_if_before_ast_to_cfg_prog.axioms)" and 
...
ConstsGlobal: "(state_typ_wf A [] (global_state n_s) (append no_guard_if_before_ast_to_cfg_prog.constants_vdecls no_guard_if_before_ast_to_cfg_prog.globals_vdecls))"
shows "(s' \<noteq> Failure)"
proof -
let ?n_s_c = "(nstate_global_restriction n_s no_guard_if_before_ast_to_cfg_prog.constants_vdecls)"
let ?\<Lambda> = "((append no_guard_if_before_ast_to_cfg_prog.constants_vdecls no_guard_if_before_ast_to_cfg_prog.globals_vdecls),(append no_guard_if_passive_prog.params_vdecls no_guard_if_passive_prog.locals_vdecls))"
let ?\<Lambda>c = "((no_guard_if_before_ast_to_cfg_prog.constants_vdecls,[])::(var_context))"
