...
definition block_1
  where
    "block_1  = [(Assume (BinOp (Var 0) Gt (Lit (LInt 0)))),(Assert (BinOp (Var 0) Ge (Lit (LInt 0)))),(Assume (Lit (LBool False)))]"
definition block_2
  where
...
definition block_4
  where
    "block_4  = [(Assume (BinOp (Var 0) Ge (Lit (LInt 0))))]"
definition block_5
  where
    "block_5  = [(Assign 0 (Lit (LInt 0))),(Assert (BinOp (Var 0) Ge (Lit (LInt 0))))]"
definition block_6
  where
    "block_6  = []"
definition block_7
