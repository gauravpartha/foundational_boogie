...
definition bigblock_0
  where
    "bigblock_0  = (BigBlock (None ) [(Havoc 0),(Havoc 1)] (Some (ParsedIf (Some (BinOp (Var 0) Gt (Lit (LInt 0)))) [(BigBlock (None ) [] (None ) (None ))] [(BigBlock (None ) [(Assign 0 (BinOp (Var 0) Sub (Lit (LInt 1))))] (Some (WhileWrapper (ParsedWhile (Some (BinOp (Var 1) Gt (Lit (LInt 0)))) [] [(BigBlock (None ) [(Assign 1 (BinOp (Var 1) Sub (Lit (LInt 1))))] (None ) (None ))]))) (None ))])) (None ))"
definition bigblock_1
  where
    "bigblock_1  = (BigBlock (None ) [] (None ) (None ))"
...
definition bigblock_5
  where
    "bigblock_5  = (BigBlock (None ) [(Assert (BinOp (Var 0) Lt (Lit (LInt 0))))] (None ) (None ))"
definition cont_5
  where
    "cont_5  = KStop"
definition cont_0
