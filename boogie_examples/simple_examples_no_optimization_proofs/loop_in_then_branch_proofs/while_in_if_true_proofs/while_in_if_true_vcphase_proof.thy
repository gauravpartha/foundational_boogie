...
definition vc_anon4
  where
    "vc_anon4 x_2 = (x_2 \<ge> (0::int))"
definition vc_anon5_Else
  where
    "vc_anon5_Else x_0 x_2 = ((((0::int) \<ge> x_0) \<and> (x_2 = x_0)) \<longrightarrow> (vc_anon4 x_2))"
...
definition vc_anon5_Then
  where
    "vc_anon5_Then x_0 x_1 y_1 x_2 = (((x_0 > (0::int)) \<and> (x_1 = (x_0 - (1::int)))) \<longrightarrow> ((vc_anon6_LoopDone y_1 x_2 x_1) \<and> (vc_anon6_LoopBody )))"
definition vc_anon0
  where
    "vc_anon0 x_0 x_1 y_1 x_2 = ((vc_anon5_Then x_0 x_1 y_1 x_2) \<and> (vc_anon5_Else x_0 x_2))"

end

locale passification = 
fixes A :: "(('a)absval_ty_fun)" and \<Lambda> :: "(var_context)" and \<Gamma> :: "(('a)fun_interp)" and n_s :: "(('a)nstate)" and vc_x :: "int" and vc_y :: "int" and vc_x_0 :: "int" and vc_y_0 :: "int" and vc_x_1 :: "int" and vc_y_1 :: "int" and vc_y_2 :: "int" and vc_x_2 :: "int"
assumes 
...
G6: "((lookup_var \<Lambda> n_s 7) = (Some (IntV vc_y_2)))" and 
G7: "((lookup_var \<Lambda> n_s 6) = (Some (IntV vc_x_2)))" and 
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> while_in_if_true_passive_prog.block_1 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon6_LoopBody ) \<Longrightarrow> (s' = Magic)))"
unfolding while_in_if_true_passive_prog.block_1_def vc.vc_anon6_LoopBody_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> while_in_if_true_passive_prog.block_2 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon4 vc_x_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> (n_s' = n_s))))))"
unfolding while_in_if_true_passive_prog.block_2_def vc.vc_anon4_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> while_in_if_true_passive_prog.block_3 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon5_Else vc_x_0 vc_x_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon4 vc_x_2)))))))"
unfolding while_in_if_true_passive_prog.block_3_def vc.vc_anon5_Else_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> while_in_if_true_passive_prog.block_4 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon6_LoopDone vc_y_1 vc_x_2 vc_x_1) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon4 vc_x_2)))))))"
unfolding while_in_if_true_passive_prog.block_4_def vc.vc_anon6_LoopDone_def
...
"((vc.vc_anon5_Then vc_x_0 vc_x_1 vc_y_1 vc_x_2) \<and> (vc.vc_anon5_Else vc_x_0 vc_x_2))"
shows "((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon5_Then vc_x_0 vc_x_1 vc_y_1 vc_x_2) \<and> (vc.vc_anon5_Else vc_x_0 vc_x_2))))))"
using assms
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> while_in_if_true_passive_prog.block_9 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 vc_x_0 vc_x_1 vc_y_1 vc_x_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon5_Then vc_x_0 vc_x_1 vc_y_1 vc_x_2) \<and> (vc.vc_anon5_Else vc_x_0 vc_x_2))))))))"
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_magic[OF assms(1) while_in_if_true_passive_prog.node_1])
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_2[OF assms(1) while_in_if_true_passive_prog.node_2])
...
"(vc.vc_anon5_Else vc_x_0 vc_x_2)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step[OF assms(1) while_in_if_true_passive_prog.node_4])
apply (erule block_anon6_LoopDoneAA0[OF _ assms(2)])
apply ((simp add:while_in_if_true_passive_prog.outEdges_4))
apply (erule member_elim, simp)
apply (erule cfg_block_anon4, simp?)
by (simp add: member_rec(2))
...
"(vc.vc_anon5_Then vc_x_0 vc_x_1 vc_y_1 vc_x_2)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
...
"(vc.vc_anon0 vc_x_0 vc_x_1 vc_y_1 vc_x_2)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
