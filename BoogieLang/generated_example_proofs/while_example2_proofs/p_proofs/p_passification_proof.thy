...
"((R 0) = (Some (Inl 2)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [4])) (update_nstate_rel R [(0,(Inl 4))]) R_old p_passive_prog.block_1 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 0) = (Some (Inl 3)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [5])) (update_nstate_rel R [(0,(Inl 5))]) R_old p_passive_prog.block_3 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [3])) (update_nstate_rel R [(0,(Inl 3))]) R_old p_passive_prog.block_4 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"(passive_lemma_assms A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> [] R R_old U0 D0 n_s)" and 
"((R 0) = (Some (Inl 2)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old p_passive_prog.block_5 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [2])) (update_nstate_rel R [(0,(Inl 2))]) R_old p_passive_prog.block_6 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [1])) (update_nstate_rel R [(0,(Inl 1))]) R_old p_passive_prog.block_7 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
lemma block_0:
assumes 
"(red_cmd_list A M \<Lambda>1 \<Gamma> \<Omega> p_before_passive_prog.block_8 (Normal n_s) s')" and 
"(passive_lemma_assms A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> [] R R_old U0 D0 n_s)"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old p_passive_prog.block_8 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
unfolding p_before_passive_prog.block_8_def p_passive_prog.block_8_def
apply (passive_rel_tac)
apply (unfold type_rel_def, simp, (intro conjI)?)
by simp
...
assumes 
"(red_cmd_list A M \<Lambda>1 \<Gamma> \<Omega> p_before_passive_prog.block_9 (Normal n_s) s')" and 
"(passive_lemma_assms A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> [] R R_old U0 D0 n_s)"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old p_passive_prog.block_9 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
unfolding p_before_passive_prog.block_9_def p_passive_prog.block_9_def
apply (passive_rel_tac)
apply (unfold type_rel_def, simp, (intro conjI)?)
by simp
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm p_before_passive_prog.node_1},@{thm p_before_passive_prog.outEdges_1}) (@{thm p_passive_prog.node_1},@{thm p_passive_prog.outEdges_1}) @{thm block_anon5_LoopBody} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm p_before_passive_prog.node_2},@{thm p_before_passive_prog.outEdges_2}) (@{thm p_passive_prog.node_2},@{thm p_passive_prog.outEdges_2}) @{thm block_anon6_LoopDone} [
@{thm cfg_block_GeneratedUnifiedExit}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm p_before_passive_prog.node_3},@{thm p_before_passive_prog.outEdges_3}) (@{thm p_passive_prog.node_3},@{thm p_passive_prog.outEdges_3}) @{thm block_anon6_LoopBody} [
@{thm cfg_block_GeneratedUnifiedExit}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_4},@{thm p_before_passive_prog.outEdges_4}) (@{thm p_passive_prog.node_4},@{thm p_passive_prog.outEdges_4}) @{thm block_anon6_LoopHead} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm p_before_passive_prog.node_5},@{thm p_before_passive_prog.outEdges_5}) (@{thm p_passive_prog.node_5},@{thm p_passive_prog.outEdges_5}) @{thm block_anon5_LoopDone} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_6},@{thm p_before_passive_prog.outEdges_6}) (@{thm p_passive_prog.node_6},@{thm p_passive_prog.outEdges_6}) @{thm block_anon5_LoopHead} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_7},@{thm p_before_passive_prog.outEdges_7}) (@{thm p_passive_prog.node_7},@{thm p_passive_prog.outEdges_7}) @{thm block_anon0} [
@{thm cfg_block_anon5_LoopHead}] 1\<close>))

lemma cfg_block_0:
assumes 
"(red_cfg_multi A M \<Lambda>1 \<Gamma> \<Omega> p_before_passive_prog.proc_body ((Inl 8),(Normal n_s)) (m',s'))" and 
"(passive_lemma_assms_2 A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> 1 R R_old U0 D0 n_s)"
shows "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> \<Omega> p_passive_prog.proc_body u (Inl 8)))))"
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_8},@{thm p_before_passive_prog.outEdges_8}) (@{thm p_passive_prog.node_8},@{thm p_passive_prog.outEdges_8}) @{thm block_0} [
@{thm cfg_block_anon0}] 1\<close>))

lemma cfg_block_PreconditionGeneratedEntry:
assumes 
"(red_cfg_multi A M \<Lambda>1 \<Gamma> \<Omega> p_before_passive_prog.proc_body ((Inl 9),(Normal n_s)) (m',s'))" and 
"(passive_lemma_assms_2 A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> 1 R R_old U0 D0 n_s)"
shows "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> \<Omega> p_passive_prog.proc_body u (Inl 9)))))"
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_9},@{thm p_before_passive_prog.outEdges_9}) (@{thm p_passive_prog.node_9},@{thm p_passive_prog.outEdges_9}) @{thm block_PreconditionGeneratedEntry} [
...
proof
assume A1: "(s' = Failure)"
have "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> [] p_passive_prog.proc_body u (Inl 9)))))"
...
with A1 obtain u mp' where uElem: "(Set.member u U0)" and AredPassive:"(red_cfg_multi A M \<Lambda>2 \<Gamma> [] p_passive_prog.proc_body ((Inl 9),(Normal u)) (mp',Failure))"
