theory nested_loop2_before_cfg_to_dag_prog
imports Boogie_Lang.Semantics Boogie_Lang.TypeSafety Boogie_Lang.Util "../global_data"
begin
definition block_0
  where
    "block_0  = [(Assign 0 (Lit (LInt 10))),(Assign 1 (Lit (LInt 10)))]"
definition block_1
  where
    "block_1  = []"
definition block_2
  where
    "block_2  = [(Assume (Lit (LBool True)))]"
definition block_3
  where
...
definition block_6
  where
    "block_6  = [(Assume (BinOp (Var 1) Gt (Lit (LInt 0)))),(Assign 1 (BinOp (Var 1) Sub (Lit (LInt 1))))]"
definition block_7
  where
...
definition block_11
  where
    "block_11  = [(Assume (UnOp Not (Lit (LBool True))))]"
definition outEdges
  where
...
shows "(((map fst (append nested_loop2_before_cfg_to_dag_prog.constants_vdecls nested_loop2_before_cfg_to_dag_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append nested_loop2_before_cfg_to_dag_prog.constants_vdecls nested_loop2_before_cfg_to_dag_prog.globals_vdecls)))) \<le> 0))"
unfolding nested_loop2_before_cfg_to_dag_prog.constants_vdecls_def nested_loop2_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append nested_loop2_before_cfg_to_dag_prog.constants_vdecls nested_loop2_before_cfg_to_dag_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
using globals_max_aux helper_max
by blast

lemma locals_min_aux:
shows "(((map fst (append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)) \<noteq> []) \<longrightarrow> ((Min (set (map fst (append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)))) \<ge> 0))"
unfolding nested_loop2_before_cfg_to_dag_prog.params_vdecls_def nested_loop2_before_cfg_to_dag_prog.locals_vdecls_def
by simp

lemma locals_min:
shows "(\<forall> x. ((Set.member x (set (map fst (append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)))) \<longrightarrow> (x \<ge> 0)))"
using locals_min_aux helper_min
by blast

lemma globals_locals_disj:
shows "((Set.inter (set (map fst (append nested_loop2_before_cfg_to_dag_prog.constants_vdecls nested_loop2_before_cfg_to_dag_prog.globals_vdecls))) (set (map fst (append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)))) = {})"
unfolding nested_loop2_before_cfg_to_dag_prog.constants_vdecls_def nested_loop2_before_cfg_to_dag_prog.globals_vdecls_def
by simp
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop2_before_cfg_to_dag_prog.constants_vdecls) )"
unfolding nested_loop2_before_cfg_to_dag_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop2_before_cfg_to_dag_prog.globals_vdecls) )"
unfolding nested_loop2_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma params_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop2_before_cfg_to_dag_prog.params_vdecls) )"
unfolding nested_loop2_before_cfg_to_dag_prog.params_vdecls_def
by simp

lemma locals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop2_before_cfg_to_dag_prog.locals_vdecls) )"
unfolding nested_loop2_before_cfg_to_dag_prog.locals_vdecls_def
by simp

lemma var_context_wf:
shows "(\<forall> x \<tau>. (((lookup_var_ty ((append nested_loop2_before_cfg_to_dag_prog.constants_vdecls nested_loop2_before_cfg_to_dag_prog.globals_vdecls),(append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)) x) = (Some \<tau>)) \<longrightarrow> ((wf_ty 0) \<tau>)))"
apply (rule lookup_ty_pred_2)
by ((simp_all add:consts_wf globals_wf params_wf locals_wf))

lemma m_x:
shows "((map_of (append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls) 0) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_y:
shows "((map_of (append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls) 1) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma l_x:
shows "((lookup_var_decl ((append nested_loop2_before_cfg_to_dag_prog.constants_vdecls nested_loop2_before_cfg_to_dag_prog.globals_vdecls),(append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)) 0) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append nested_loop2_before_cfg_to_dag_prog.constants_vdecls nested_loop2_before_cfg_to_dag_prog.globals_vdecls),(append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)) 0) = (Some (TPrim TInt)))"
