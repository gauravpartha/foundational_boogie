...
definition block_1
  where
    "block_1  = [(Assume (BinOp (Var 0) Eq (Lit (LInt 5)))),(Assert (BinOp (Var 0) Eq (Lit (LInt 5))))]"
definition block_2
  where
    "block_2  = [(Assign 0 (BinOp (Var 0) Sub (Lit (LInt 1)))),(Assume (Lit (LBool False)))]"
definition block_3
  where
    "block_3  = [(Assume (BinOp (Var 0) Neq (Lit (LInt 5))))]"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Var 0) Gt (Lit (LInt 0))))]"
definition block_5
  where
    "block_5  = [(Assert (BinOp (Var 0) Neq (Lit (LInt 5))))]"
definition block_6
  where
