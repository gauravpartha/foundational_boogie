...
shows "(((map fst (append triangle_before_cfg_to_dag_prog.constants_vdecls triangle_before_cfg_to_dag_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append triangle_before_cfg_to_dag_prog.constants_vdecls triangle_before_cfg_to_dag_prog.globals_vdecls)))) \<le> 0))"
unfolding triangle_before_cfg_to_dag_prog.constants_vdecls_def triangle_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append triangle_before_cfg_to_dag_prog.constants_vdecls triangle_before_cfg_to_dag_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
shows "((Set.inter (set (map fst (append triangle_before_cfg_to_dag_prog.constants_vdecls triangle_before_cfg_to_dag_prog.globals_vdecls))) (set (map fst (append triangle_before_cfg_to_dag_prog.params_vdecls triangle_before_cfg_to_dag_prog.locals_vdecls)))) = {})"
unfolding triangle_before_cfg_to_dag_prog.constants_vdecls_def triangle_before_cfg_to_dag_prog.globals_vdecls_def
by simp
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) triangle_before_cfg_to_dag_prog.constants_vdecls) )"
unfolding triangle_before_cfg_to_dag_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) triangle_before_cfg_to_dag_prog.globals_vdecls) )"
unfolding triangle_before_cfg_to_dag_prog.globals_vdecls_def
by simp
...
shows "(\<forall> x \<tau>. (((lookup_var_ty ((append triangle_before_cfg_to_dag_prog.constants_vdecls triangle_before_cfg_to_dag_prog.globals_vdecls),(append triangle_before_cfg_to_dag_prog.params_vdecls triangle_before_cfg_to_dag_prog.locals_vdecls)) x) = (Some \<tau>)) \<longrightarrow> ((wf_ty 0) \<tau>)))"
