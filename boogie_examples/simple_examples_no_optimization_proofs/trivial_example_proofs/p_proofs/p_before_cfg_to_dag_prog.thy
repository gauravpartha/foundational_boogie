...
definition fdecls
  where
    "fdecls  = [(''f'',0,[(TPrim TInt)],(TPrim TBool))]"
...
shows "(((map fst (append p_before_cfg_to_dag_prog.constants_vdecls p_before_cfg_to_dag_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append p_before_cfg_to_dag_prog.constants_vdecls p_before_cfg_to_dag_prog.globals_vdecls)))) \<le> 0))"
unfolding p_before_cfg_to_dag_prog.constants_vdecls_def p_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append p_before_cfg_to_dag_prog.constants_vdecls p_before_cfg_to_dag_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
lemma m_a:
shows "((map_of (append p_before_cfg_to_dag_prog.params_vdecls p_before_cfg_to_dag_prog.locals_vdecls) 1) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)
...
lemma l_a:
shows "((lookup_var_decl ((append p_before_cfg_to_dag_prog.constants_vdecls p_before_cfg_to_dag_prog.globals_vdecls),(append p_before_cfg_to_dag_prog.params_vdecls p_before_cfg_to_dag_prog.locals_vdecls)) 1) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append p_before_cfg_to_dag_prog.constants_vdecls p_before_cfg_to_dag_prog.globals_vdecls),(append p_before_cfg_to_dag_prog.params_vdecls p_before_cfg_to_dag_prog.locals_vdecls)) 1) = (Some (TPrim TInt)))"
