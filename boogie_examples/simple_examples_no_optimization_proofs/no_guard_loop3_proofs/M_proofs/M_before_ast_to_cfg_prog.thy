...
definition bigblock_3
  where
    "bigblock_3  = (BigBlock (None ) [] (Some (ParsedWhile (None ) [] [(BigBlock (None ) [(Assign 0 (BinOp (BinOp (Var 0) Add (Var 1)) Add (Var 2)))] (Some (ParsedIf (Some (BinOp (BinOp (Var 0) Sub (Lit (LInt 10))) Gt (Lit (LInt 200)))) [(BigBlock (None ) [(Assign 1 (BinOp (Var 2) Add (Lit (LInt 7))))] (None ) (None ))] [(BigBlock (None ) [] (None ) (None ))])) (None ))])) (None ))"
definition bigblock_4
  where
    "bigblock_4  = (BigBlock (None ) [(Assign 0 (BinOp (BinOp (Var 0) Add (Var 1)) Add (Var 2)))] (Some (ParsedIf (Some (BinOp (BinOp (Var 0) Sub (Lit (LInt 10))) Gt (Lit (LInt 200)))) [(BigBlock (None ) [(Assign 1 (BinOp (Var 2) Add (Lit (LInt 7))))] (None ) (None ))] [(BigBlock (None ) [] (None ) (None ))])) (None ))"
definition bigblock_5
  where
    "bigblock_5  = (BigBlock (None ) [(Assign 1 (BinOp (Var 2) Add (Lit (LInt 7))))] (None ) (None ))"
...
definition cont_0
  where
    "cont_0  = (KSeq bigblock_8 cont_8)"
definition cont_1
  where
    "cont_1  = (KEndBlock (KSeq bigblock_8 cont_8 ))"
definition cont_7
  where
    "cont_7  = (KSeq bigblock_1 cont_1)"
definition cont_2
  where
    "cont_2  = (KSeq bigblock_7 cont_7)"
definition cont_3
  where
    "cont_3  = (KEndBlock (KSeq bigblock_7 cont_7 ))"
definition cont_4
  where
    "cont_4  = (KSeq bigblock_3 cont_3)"
definition cont_5
  where
    "cont_5  = (KSeq bigblock_3 cont_3)"
definition cont_6
  where
    "cont_6  = (KSeq bigblock_3 cont_3)"
definition proc_body
  where
    "proc_body  = [bigblock_0,bigblock_8]"
definition pres
  where
    "pres  = []"
definition post
