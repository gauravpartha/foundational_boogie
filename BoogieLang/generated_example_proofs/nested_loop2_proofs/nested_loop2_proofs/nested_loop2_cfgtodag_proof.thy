...
imports Boogie_Lang.Semantics Boogie_Lang.Util Boogie_Lang.BackedgeElim Boogie_Lang.TypingML nested_loop2_before_cfg_to_dag_prog nested_loop2_before_passive_prog nested_loop2_passification_proof nested_loop2_vcphase_proof
begin
...
shows "(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 nested_loop2_before_cfg_to_dag_prog.post)"
unfolding expr_all_sat_def nested_loop2_before_cfg_to_dag_prog.post_def 
...
unfolding nested_loop2_before_cfg_to_dag_prog.block_9_def nested_loop2_before_passive_prog.block_1_def
...
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
...
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] nested_loop2_before_passive_prog.block_2 ns2 s' True)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding nested_loop2_before_cfg_to_dag_prog.block_8_def nested_loop2_before_passive_prog.block_2_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
IH_anon6_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.proc_body [0,1] [] nested_loop2_before_cfg_to_dag_prog.post ns1 s' 1 m' j)"
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding nested_loop2_before_cfg_to_dag_prog.block_7_def nested_loop2_before_passive_prog.block_3_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
apply (erule type_safety_top_level_inv[OF Wf_Fun global_data.funcs_wf nested_loop2_before_cfg_to_dag_prog.var_context_wf])
apply (simp)
apply ((tactic \<open> typing_tac @{context} [] @{thms nested_loop2_before_cfg_to_dag_prog.l_x(2)} [] 1\<close>))
...
IH_anon7_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.proc_body [0,1] [(BinOp (Var 0) Ge (Lit (LInt 0)))] nested_loop2_before_cfg_to_dag_prog.post ns1 s' 3 m' j)"
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
apply (rule cfg_dag_helper_2[OF Red _ _ DagVerifies DagAssms])
...
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [(BinOp (Var 1) Ge (Lit (LInt 0)))] nested_loop2_before_passive_prog.block_4 ns2 s' True)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding nested_loop2_before_cfg_to_dag_prog.block_6_def nested_loop2_before_passive_prog.block_4_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
apply (erule type_safety_top_level_inv[OF Wf_Fun global_data.funcs_wf nested_loop2_before_cfg_to_dag_prog.var_context_wf])
apply (simp)
apply ((tactic \<open> typing_tac @{context} [] @{thms nested_loop2_before_cfg_to_dag_prog.l_y(2)} [] 1\<close>))
...
IH_anon8_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.proc_body [1] [(BinOp (Var 1) Ge (Lit (LInt 0)))] nested_loop2_before_cfg_to_dag_prog.post ns1 s' 5 m' j)"
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
apply (rule cfg_dag_helper_2[OF Red _ _ DagVerifies DagAssms])
...
apply cfg_dag_rel_tac_single+
apply simp
apply ((simp add:nested_loop2_before_cfg_to_dag_prog.l_y(1)))
apply simp
done
...
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] nested_loop2_before_passive_prog.block_7 ns2 s' False)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding nested_loop2_before_cfg_to_dag_prog.block_3_def nested_loop2_before_passive_prog.block_7_def
apply cfg_dag_rel_tac_single+
apply simp
apply ((simp add:nested_loop2_before_cfg_to_dag_prog.l_x(1)))
apply ((simp add:nested_loop2_before_cfg_to_dag_prog.l_y(1)))
apply simp
done
...
apply ((simp add:nested_loop2_before_passive_prog.outEdges_7))
apply ((simp add:member_rec(1)))
...
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [(BinOp (Var 0) Ge (Lit (LInt 0)))] nested_loop2_before_passive_prog.block_8 ns2 s' False)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding nested_loop2_before_cfg_to_dag_prog.block_2_def nested_loop2_before_passive_prog.block_8_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
apply (erule type_safety_top_level_inv[OF Wf_Fun global_data.funcs_wf nested_loop2_before_cfg_to_dag_prog.var_context_wf])
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding nested_loop2_before_cfg_to_dag_prog.block_1_def nested_loop2_before_passive_prog.block_9_def
apply cfg_dag_rel_tac_single+
apply simp
apply ((simp add:nested_loop2_before_cfg_to_dag_prog.l_x(1)))
apply ((simp add:nested_loop2_before_cfg_to_dag_prog.l_y(1)))
...
DagVerifies: "(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] nested_loop2_before_passive_prog.proc_body ((Inl 9),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))"
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
using Red DagAssms
proof (induction j arbitrary: ns1 rule: less_induct)
case (less j)
...
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] nested_loop2_before_passive_prog.block_10 ns2 s' False)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding nested_loop2_before_cfg_to_dag_prog.block_0_def nested_loop2_before_passive_prog.block_10_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
DagAssms: "(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)" and 
DagVerifies: "(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] nested_loop2_before_passive_prog.proc_body ((Inl 10),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))"
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
...
lemma cfg_block_0:
assumes 
"(\<forall> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] nested_loop2_before_passive_prog.proc_body ((Inl 11),(Normal ns2)) (m2',s2')) \<longrightarrow> (s2' \<noteq> Failure)))" and 
"(nstate_same_on \<Lambda>1 ns1 ns2 {})" and 
"(state_well_typed A \<Lambda>1 [] ns1)" and 
"(state_well_typed A \<Lambda>1 [] ns2)" and 
"((\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] nested_loop2_before_passive_prog.proc_body ((Inl 10),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure))) \<Longrightarrow> R)"
shows "R"
using assms
apply (rule cfg_dag_empty_propagate_helper)
apply (assumption, simp)
apply ((simp add:nested_loop2_before_passive_prog.outEdges_11))
by ((simp add:nested_loop2_before_passive_prog.node_11 nested_loop2_before_passive_prog.block_11_def))
...
"(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] nested_loop2_before_passive_prog.proc_body ((Inl 12),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))" and 
"(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 nested_loop2_before_cfg_to_dag_prog.pres)"
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
apply (rule cfg_dag_helper_entry)
apply (rule nested_loop2_before_passive_prog.node_12)
apply (erule assms(3))
apply (rule assms(2))
unfolding nested_loop2_before_passive_prog.block_12_def
apply (rule assume_pres_normal[where ?es=nested_loop2_before_cfg_to_dag_prog.pres])
apply (rule assms(4))
unfolding nested_loop2_before_cfg_to_dag_prog.pres_def
apply simp
apply (rule nested_loop2_before_passive_prog.outEdges_12)
apply ((simp add:nested_loop2_before_passive_prog.node_11 nested_loop2_before_passive_prog.block_11_def))
apply (rule nested_loop2_before_passive_prog.outEdges_11)
...
abbreviation \<Lambda>0
  where
    "\<Lambda>0  \<equiv> ((append global_data.constants_vdecls global_data.globals_vdecls),(append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls))"
lemma end_to_end_theorem_aux:
assumes 
Red: "(red_cfg_multi A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)) \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.proc_body ((Inl 0),(Normal ns)) (m',s'))" and 
...
Precondition: "(expr_all_sat A \<Lambda>0 \<Gamma> [] ns nested_loop2_before_cfg_to_dag_prog.pres)" and 
...
shows "(valid_configuration A \<Lambda>0 \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.post m' s')"
proof -
from Red obtain j where Aux:"(red_cfg_k_step A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append nested_loop2_before_cfg_to_dag_prog.params_vdecls nested_loop2_before_cfg_to_dag_prog.locals_vdecls)) \<Gamma> [] nested_loop2_before_cfg_to_dag_prog.proc_body ((Inl 0),(Normal ns)) j (m',s'))"
...
assumes 
VC: "(\<And> (vc_x::int) (vc_y::int) (vc_x_0::int) (vc_y_0::int) (vc_x_1::int) (vc_y_1::int) (vc_y_2::int) (vc_x_2::int) (vc_y_3::int). (vc.vc_anon0 vc_x_0 vc_x_1 vc_y_1 vc_y_2 vc_x_2 vc_y_3))"
shows "(\<And> A. (proc_is_correct (A::(('a)absval_ty_fun)) global_data.fdecls global_data.constants_vdecls global_data.globals_vdecls global_data.axioms nested_loop2_before_cfg_to_dag_prog.proc))"
apply (rule end_to_end_util[OF end_to_end_theorem_aux])
apply assumption using VC apply simp  apply assumption+
by (simp_all add: exprs_to_only_checked_spec_1 exprs_to_only_checked_spec_2 nested_loop2_before_cfg_to_dag_prog.proc_def nested_loop2_before_cfg_to_dag_prog.proc_body_def)
