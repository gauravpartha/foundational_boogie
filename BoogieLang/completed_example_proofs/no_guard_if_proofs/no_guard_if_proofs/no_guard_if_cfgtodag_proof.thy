...
imports Boogie_Lang.Semantics Boogie_Lang.Util Boogie_Lang.BackedgeElim Boogie_Lang.TypingML no_guard_if_before_cfg_to_dag_prog no_guard_if_before_passive_prog no_guard_if_passification_proof no_guard_if_vcphase_proof
begin
...
shows "(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 no_guard_if_before_cfg_to_dag_prog.post)"
unfolding expr_all_sat_def no_guard_if_before_cfg_to_dag_prog.post_def 
...
unfolding no_guard_if_before_cfg_to_dag_prog.block_2_def no_guard_if_before_passive_prog.block_1_def
...
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] no_guard_if_before_cfg_to_dag_prog.post m' s')"
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding no_guard_if_before_cfg_to_dag_prog.block_1_def no_guard_if_before_passive_prog.block_2_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
"(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 no_guard_if_before_cfg_to_dag_prog.pres)"
shows "(valid_configuration A \<Lambda>1 \<Gamma> [] no_guard_if_before_cfg_to_dag_prog.post m' s')"
...
apply (rule assume_pres_normal[where ?es=no_guard_if_before_cfg_to_dag_prog.pres])
apply (rule assms(4))
unfolding no_guard_if_before_cfg_to_dag_prog.pres_def
apply simp
...
abbreviation \<Lambda>0
  where
    "\<Lambda>0  \<equiv> ((append global_data.constants_vdecls global_data.globals_vdecls),(append no_guard_if_before_cfg_to_dag_prog.params_vdecls no_guard_if_before_cfg_to_dag_prog.locals_vdecls))"
lemma end_to_end_theorem_aux:
assumes 
Red: "(red_cfg_multi A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append no_guard_if_before_cfg_to_dag_prog.params_vdecls no_guard_if_before_cfg_to_dag_prog.locals_vdecls)) \<Gamma> [] no_guard_if_before_cfg_to_dag_prog.proc_body ((Inl 0),(Normal ns)) (m',s'))" and 
...
Precondition: "(expr_all_sat A \<Lambda>0 \<Gamma> [] ns no_guard_if_before_cfg_to_dag_prog.pres)" and 
...
shows "(valid_configuration A \<Lambda>0 \<Gamma> [] no_guard_if_before_cfg_to_dag_prog.post m' s')"
proof -
from Red obtain j where Aux:"(red_cfg_k_step A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append no_guard_if_before_cfg_to_dag_prog.params_vdecls no_guard_if_before_cfg_to_dag_prog.locals_vdecls)) \<Gamma> [] no_guard_if_before_cfg_to_dag_prog.proc_body ((Inl 0),(Normal ns)) j (m',s'))"
...
shows "(\<And> A. (proc_is_correct (A::(('a)absval_ty_fun)) global_data.fdecls global_data.constants_vdecls global_data.globals_vdecls global_data.axioms no_guard_if_before_cfg_to_dag_prog.proc))"
apply (rule end_to_end_util[OF end_to_end_theorem_aux])
apply assumption using VC apply simp  apply assumption+
by (simp_all add: exprs_to_only_checked_spec_1 exprs_to_only_checked_spec_2 no_guard_if_before_cfg_to_dag_prog.proc_def no_guard_if_before_cfg_to_dag_prog.proc_body_def)
