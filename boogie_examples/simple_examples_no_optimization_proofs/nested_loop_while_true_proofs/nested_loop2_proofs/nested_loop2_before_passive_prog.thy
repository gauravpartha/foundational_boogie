...
definition block_9
  where
    "block_9  = [(Havoc 0),(Havoc 1),(Assume (BinOp (Var 0) Ge (Lit (LInt 0))))]"
definition block_10
  where
    "block_10  = [(Assume (Lit (LBool True))),(Assert (BinOp (Var 0) Ge (Lit (LInt 0))))]"
definition block_11
  where
    "block_11  = [(Havoc 0),(Havoc 1)]"
definition block_12
  where
    "block_12  = [(Assign 0 (Lit (LInt 10))),(Assign 1 (Lit (LInt 10)))]"
definition block_13
  where
    "block_13  = []"
definition block_14
