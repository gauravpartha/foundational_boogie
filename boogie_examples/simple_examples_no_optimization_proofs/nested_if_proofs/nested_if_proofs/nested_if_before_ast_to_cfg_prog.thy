theory nested_if_before_ast_to_cfg_prog
imports Boogie_Lang.Ast Boogie_Lang.Semantics Boogie_Lang.TypeSafety Boogie_Lang.Util "../global_data"
begin
definition bigblock_0
  where
    "bigblock_0  = (BigBlock (None ) [] (Some (ParsedIf (Some (BinOp (Var 0) Gt (Lit (LInt 0)))) [(BigBlock (None ) [] (Some (ParsedIf (Some (BinOp (Var 1) Gt (Lit (LInt 0)))) [(BigBlock (None ) [(Assign 1 (BinOp (Var 1) Add (Var 0)))] (None ) (None ))] [(BigBlock (None ) [(Assign 1 (Var 0))] (None ) (None ))])) (None ))] [(BigBlock (None ) [] (None ) (None ))])) (None ))"
definition bigblock_1
  where
    "bigblock_1  = (BigBlock (None ) [] (Some (ParsedIf (Some (BinOp (Var 1) Gt (Lit (LInt 0)))) [(BigBlock (None ) [(Assign 1 (BinOp (Var 1) Add (Var 0)))] (None ) (None ))] [(BigBlock (None ) [(Assign 1 (Var 0))] (None ) (None ))])) (None ))"
definition bigblock_2
  where
    "bigblock_2  = (BigBlock (None ) [(Assign 1 (BinOp (Var 1) Add (Var 0)))] (None ) (None ))"
definition bigblock_3
  where
    "bigblock_3  = (BigBlock (None ) [(Assign 1 (Var 0))] (None ) (None ))"
...
shows "(((map fst (append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls)))) \<le> 0))"
unfolding nested_if_before_ast_to_cfg_prog.constants_vdecls_def nested_if_before_ast_to_cfg_prog.globals_vdecls_def
by simp

lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_if_before_ast_to_cfg_prog.constants_vdecls) )"
unfolding nested_if_before_ast_to_cfg_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_if_before_ast_to_cfg_prog.globals_vdecls) )"
unfolding nested_if_before_ast_to_cfg_prog.globals_vdecls_def
by simp

lemma params_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_if_before_ast_to_cfg_prog.params_vdecls) )"
unfolding nested_if_before_ast_to_cfg_prog.params_vdecls_def
by simp

lemma locals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_if_before_ast_to_cfg_prog.locals_vdecls) )"
unfolding nested_if_before_ast_to_cfg_prog.locals_vdecls_def
by simp

lemma var_context_wf:
shows "(\<forall> x \<tau>. (((lookup_var_ty ((append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls),(append nested_if_before_ast_to_cfg_prog.params_vdecls nested_if_before_ast_to_cfg_prog.locals_vdecls)) x) = (Some \<tau>)) \<longrightarrow> ((wf_ty 0) \<tau>)))"
apply (rule lookup_ty_pred_2)
by ((simp_all add:consts_wf globals_wf params_wf locals_wf))

lemma m_n:
shows "((map_of (append nested_if_before_ast_to_cfg_prog.params_vdecls nested_if_before_ast_to_cfg_prog.locals_vdecls) 0) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_m:
shows "((map_of (append nested_if_before_ast_to_cfg_prog.params_vdecls nested_if_before_ast_to_cfg_prog.locals_vdecls) 1) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma l_n:
shows "((lookup_var_decl ((append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls),(append nested_if_before_ast_to_cfg_prog.params_vdecls nested_if_before_ast_to_cfg_prog.locals_vdecls)) 0) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls),(append nested_if_before_ast_to_cfg_prog.params_vdecls nested_if_before_ast_to_cfg_prog.locals_vdecls)) 0) = (Some (TPrim TInt)))"
using globals_locals_disj m_n
by (simp_all add: lookup_var_decl_global_2 lookup_var_decl_local lookup_var_decl_ty_Some)

lemma l_m:
shows "((lookup_var_decl ((append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls),(append nested_if_before_ast_to_cfg_prog.params_vdecls nested_if_before_ast_to_cfg_prog.locals_vdecls)) 1) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append nested_if_before_ast_to_cfg_prog.constants_vdecls nested_if_before_ast_to_cfg_prog.globals_vdecls),(append nested_if_before_ast_to_cfg_prog.params_vdecls nested_if_before_ast_to_cfg_prog.locals_vdecls)) 1) = (Some (TPrim TInt)))"
