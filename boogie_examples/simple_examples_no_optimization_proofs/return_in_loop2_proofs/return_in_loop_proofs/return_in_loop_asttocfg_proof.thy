...
cfgBlockDoesntFail: "(\<And> s2'. ((red_cmd_list A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.block_7 (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
shows "((reached_state \<noteq> Failure) \<and> (\<forall> ns1'. ((reached_state = (Normal ns1')) \<longrightarrow> (red_cmd_list A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.block_7 (Normal ns1) (Normal ns1')))))"
apply (rule block_local_rel_generic)
apply (rule Rel_Main_test[of return_in_loop_before_ast_to_cfg_prog.bigblock_6])
apply (simp add: return_in_loop_before_ast_to_cfg_prog.bigblock_6_def return_in_loop_before_cfg_to_dag_prog.block_7_def)
apply ((simp add: return_in_loop_before_cfg_to_dag_prog.block_7_def)+)
apply (rule astStep)
apply (rule cfgBlockDoesntFail)
apply ((simp add: return_in_loop_before_cfg_to_dag_prog.block_7_def return_in_loop_before_ast_to_cfg_prog.bigblock_6_def)+)
done
...
cfgDoesntFail: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.proc_body ((Inl 7),(Normal ns1)) (m',s')) \<Longrightarrow> (s' \<noteq> Failure)))" and 
...
apply (rule disjI1)
apply (rule return_in_loop_before_cfg_to_dag_prog.block_7_def)
...
cfgBlockDoesntFail: "(\<And> s2'. ((red_cmd_list A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.block_5 (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
shows "((reached_state \<noteq> Failure) \<and> (\<forall> ns1'. ((reached_state = (Normal ns1')) \<longrightarrow> (red_cmd_list A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.block_5 (Normal ns1) (Normal ns1')))))"
apply (rule block_local_rel_generic)
apply (rule Rel_Main_test[of return_in_loop_before_ast_to_cfg_prog.bigblock_5])
apply (simp add: return_in_loop_before_ast_to_cfg_prog.bigblock_5_def return_in_loop_before_cfg_to_dag_prog.block_5_def)
apply ((simp add: return_in_loop_before_cfg_to_dag_prog.block_5_def)+)
apply (rule astStep)
apply (rule cfgBlockDoesntFail)
apply ((simp add: return_in_loop_before_cfg_to_dag_prog.block_5_def return_in_loop_before_ast_to_cfg_prog.bigblock_5_def)+)
done
...
apply (rule disjI1)
apply (rule return_in_loop_before_cfg_to_dag_prog.block_5_def)
apply (rule cfgDoesntFail)
apply ((simp)+)
apply (rule cfgSatisfiesPosts, blast)
apply ((simp)+)
apply (rule cont_5_def)
apply (simp add: return_in_loop_before_cfg_to_dag_prog.node_5)
...
guardHint: "(red_expr A \<Lambda>1 \<Gamma> [] (BinOp (Var 0) Eq (Lit (LInt 5))) ns1 (BoolV False))" and 
inductionHypothesis: "(loop_IH j A M M' \<Lambda>1 \<Gamma> [] T return_in_loop_before_ast_to_cfg_prog.bigblock_1 cont_1 return_in_loop_before_cfg_to_dag_prog.proc_body 1 return_in_loop_before_ast_to_cfg_prog.post reached_bb reached_cont reached_state)"
shows "(Ast.valid_configuration A \<Lambda>1 \<Gamma> [] return_in_loop_before_ast_to_cfg_prog.post reached_bb reached_cont reached_state)"
proof -
show ?thesis 
...
apply (rule disjI2)
apply (rule conjI)
apply (rule return_in_loop_before_cfg_to_dag_prog.block_4_def)
apply (rule conjI)
apply (simp)
apply (rule conjI)
apply (rule neg_eq)
...
lemma rel_return_in_loop_before_ast_to_cfg_prog_bigblock_3:
assumes 
astStep: "(red_bigblock A M \<Lambda>1 \<Gamma> [] T (return_in_loop_before_ast_to_cfg_prog.bigblock_3,cont0,(Normal ns1)) (reached_bb,reached_cont,reached_state))" and 
cfgBlockDoesntFail: "(\<And> s2'. ((red_cmd_list A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.block_3 (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))" and 
guardHint: "(red_expr A \<Lambda>1 \<Gamma> [] (BinOp (Var 0) Eq (Lit (LInt 5))) ns1 (BoolV True))"
shows "((reached_state \<noteq> Failure) \<and> (\<forall> ns1'. ((reached_state = (Normal ns1')) \<longrightarrow> (red_cmd_list A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.block_3 (Normal ns1) (Normal ns1')))))"
unfolding return_in_loop_before_cfg_to_dag_prog.block_3_def
apply (rule guard_holds_push_through_assumption)
apply (rule block_local_rel_generic)
apply (rule Rel_Main_test[of return_in_loop_before_ast_to_cfg_prog.bigblock_3])
...
apply ((simp add: assms(3) return_in_loop_before_ast_to_cfg_prog.bigblock_3_def)+)
done
...
cfgDoesntFail: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.proc_body ((Inl 3),(Normal ns1)) (m',s')) \<Longrightarrow> (s' \<noteq> Failure)))" and 
cfgSatisfiesPosts: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] return_in_loop_before_cfg_to_dag_prog.proc_body ((Inl 3),(Normal ns1)) (m',s')) \<Longrightarrow> ((is_final_config (m',s')) \<Longrightarrow> (\<forall> ns_end. ((s' = (Normal ns_end)) \<longrightarrow> (expr_all_sat A \<Lambda>1 \<Gamma> [] ns_end return_in_loop_before_ast_to_cfg_prog.post))))))" and 
guardHint: "(red_expr A \<Lambda>1 \<Gamma> [] (BinOp (Var 0) Eq (Lit (LInt 5))) ns1 (BoolV True))" and 
inductionHypothesis: "(loop_IH j A M M' \<Lambda>1 \<Gamma> [] T return_in_loop_before_ast_to_cfg_prog.bigblock_1 cont_1 return_in_loop_before_cfg_to_dag_prog.proc_body 1 return_in_loop_before_ast_to_cfg_prog.post reached_bb reached_cont reached_state)"
shows "(Ast.valid_configuration A \<Lambda>1 \<Gamma> [] return_in_loop_before_ast_to_cfg_prog.post reached_bb reached_cont reached_state)"
proof -
show ?thesis
...
apply (rule disjI1)
apply (rule conjI)
apply (rule return_in_loop_before_cfg_to_dag_prog.block_3_def)
apply (rule conjI)
apply (simp)
apply (rule guardHint)
...
apply (rule rel_return_in_loop_before_ast_to_cfg_prog_bigblock_3)
apply assumption+
apply (rule guardHint)
done
qed
...
apply (rule Rel_Invs[of return_in_loop_before_ast_to_cfg_prog.bigblock_2])
apply (simp add: return_in_loop_before_cfg_to_dag_prog.block_2_def return_in_loop_before_ast_to_cfg_prog.bigblock_2_def)
...
apply (simp add: cont_2_def return_in_loop_before_ast_to_cfg_prog.bigblock_3_def cont_3_def )
apply blast+
apply (rule loop_IH_prove)
apply (rule loop_IH_apply)
apply (rule inductionHypothesis)
...
apply (simp add: cont_2_def return_in_loop_before_ast_to_cfg_prog.bigblock_4_def cont_4_def )
apply blast+
apply (rule loop_IH_prove)
apply (rule loop_IH_apply)
apply (rule inductionHypothesis)
...
apply (simp add: cont_1_def return_in_loop_before_ast_to_cfg_prog.bigblock_2_def cont_2_def return_in_loop_before_ast_to_cfg_prog.bigblock_5_def cont_5_def )
apply ((blast)+)
apply (rule loop_IH_prove)
apply (rule less.IH)
