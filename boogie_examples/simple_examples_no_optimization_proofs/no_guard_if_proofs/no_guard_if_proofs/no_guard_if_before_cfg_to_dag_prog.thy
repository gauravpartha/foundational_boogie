...
definition block_1
  where
    "block_1  = [(Assign 0 (Lit (LInt 0)))]"
definition block_2
  where
    "block_2  = [(Assign 0 (Lit (LInt 1)))]"
definition outEdges
  where
    "outEdges  = [[1,2],[],[]]"
...
shows "(((map fst (append no_guard_if_before_cfg_to_dag_prog.constants_vdecls no_guard_if_before_cfg_to_dag_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append no_guard_if_before_cfg_to_dag_prog.constants_vdecls no_guard_if_before_cfg_to_dag_prog.globals_vdecls)))) \<le> 0))"
unfolding no_guard_if_before_cfg_to_dag_prog.constants_vdecls_def no_guard_if_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append no_guard_if_before_cfg_to_dag_prog.constants_vdecls no_guard_if_before_cfg_to_dag_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
shows "((Set.inter (set (map fst (append no_guard_if_before_cfg_to_dag_prog.constants_vdecls no_guard_if_before_cfg_to_dag_prog.globals_vdecls))) (set (map fst (append no_guard_if_before_cfg_to_dag_prog.params_vdecls no_guard_if_before_cfg_to_dag_prog.locals_vdecls)))) = {})"
unfolding no_guard_if_before_cfg_to_dag_prog.constants_vdecls_def no_guard_if_before_cfg_to_dag_prog.globals_vdecls_def
by simp
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) no_guard_if_before_cfg_to_dag_prog.constants_vdecls) )"
unfolding no_guard_if_before_cfg_to_dag_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) no_guard_if_before_cfg_to_dag_prog.globals_vdecls) )"
...
shows "(\<forall> x \<tau>. (((lookup_var_ty ((append no_guard_if_before_cfg_to_dag_prog.constants_vdecls no_guard_if_before_cfg_to_dag_prog.globals_vdecls),(append no_guard_if_before_cfg_to_dag_prog.params_vdecls no_guard_if_before_cfg_to_dag_prog.locals_vdecls)) x) = (Some \<tau>)) \<longrightarrow> ((wf_ty 0) \<tau>)))"
