...
definition block_1
  where
    "block_1  = [(Assume (BinOp (Var 5) Gt (Lit (LInt 0)))),(Assume (BinOp (Var 7) Eq (BinOp (Var 5) Sub (Lit (LInt 1))))),(Assume (Lit (LBool False)))]"
definition block_2
  where
    "block_2  = [(Assert (BinOp (Var 6) Ge (Lit (LInt 0))))]"
definition block_3
  where
    "block_3  = [(Assume (BinOp (Lit (LInt 0)) Ge (Var 2))),(Assume (BinOp (Var 6) Eq (Var 2)))]"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Lit (LInt 0)) Ge (Var 5))),(Assume (BinOp (Var 6) Eq (Var 4)))]"
definition block_5
  where
    "block_5  = []"
definition block_6
  where
    "block_6  = [(Assume (BinOp (Var 2) Gt (Lit (LInt 0)))),(Assume (BinOp (Var 4) Eq (BinOp (Var 2) Sub (Lit (LInt 1)))))]"
definition block_7
  where
    "block_7  = []"
definition block_8
...
definition locals_vdecls :: "(vdecls)"
  where
    "locals_vdecls  = [(0,(TPrim TInt),(None )),(1,(TPrim TInt),(None )),(2,(TPrim TInt),(None )),(3,(TPrim TInt),(None )),(4,(TPrim TInt),(None )),(5,(TPrim TInt),(None )),(7,(TPrim TInt),(None )),(6,(TPrim TInt),(None ))]"
