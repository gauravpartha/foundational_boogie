...
imports Boogie_Lang.Semantics Boogie_Lang.Util Boogie_Lang.BackedgeElim Boogie_Lang.TypingML no_inv_loop_before_ast_to_cfg_prog no_inv_loop_before_cfg_to_dag_prog no_inv_loop_before_passive_prog no_inv_loop_passification_proof no_inv_loop_vcphase_proof
begin
...
shows "(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 no_inv_loop_before_ast_to_cfg_prog.post)"
unfolding expr_all_sat_def no_inv_loop_before_ast_to_cfg_prog.post_def 
...
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] no_inv_loop_before_ast_to_cfg_prog.post m' s')"
...
IH_anon2_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] no_inv_loop_before_cfg_to_dag_prog.proc_body [0] [] no_inv_loop_before_ast_to_cfg_prog.post ns1 s' 1 m' j)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] no_inv_loop_before_ast_to_cfg_prog.post m' s')"
...
apply cfg_dag_rel_tac_single+
apply simp
apply ((simp add:no_inv_loop_before_ast_to_cfg_prog.l_x(1)))
apply simp
done
...
"(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 no_inv_loop_before_ast_to_cfg_prog.pres)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] no_inv_loop_before_ast_to_cfg_prog.post m' s')"
...
apply (rule assume_pres_normal[where ?es=no_inv_loop_before_ast_to_cfg_prog.pres])
apply (rule assms(4))
unfolding no_inv_loop_before_ast_to_cfg_prog.pres_def
apply simp
...
shows "(Semantics.valid_configuration A \<Lambda>0 \<Gamma> [] no_inv_loop_before_ast_to_cfg_prog.post m' s')"
proof -
from Red obtain j where Aux:"(red_cfg_k_step A M ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_before_ast_to_cfg_prog.params_vdecls no_inv_loop_before_ast_to_cfg_prog.locals_vdecls)) \<Gamma> [] no_inv_loop_before_cfg_to_dag_prog.proc_body ((Inl 0),(Normal ns)) j (m',s'))"
