...
definition block_1
  where
    "block_1  = [(Assume (BinOp (Var 7) Gt (Lit (LInt 10)))),(Assume (BinOp (Var 10) Eq (BinOp (Var 8) Mul (Lit (LInt 10))))),(Assume (Lit (LBool False)))]"
definition block_2
  where
    "block_2  = [(Assume (BinOp (Var 11) Eq (BinOp (BinOp (Var 8) Add (Var 1)) Add (Var 5)))),(Assume (Lit (LBool False)))]"
definition block_3
  where
    "block_3  = [(Assume (BinOp (BinOp (Var 8) Sub (Lit (LInt 10))) Gt (Lit (LInt 200)))),(Assume (BinOp (Var 9) Eq (BinOp (Var 5) Add (Lit (LInt 7)))))]"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Lit (LInt 200)) Ge (BinOp (Var 8) Sub (Lit (LInt 10)))))]"
definition block_5
  where
    "block_5  = []"
definition block_6
  where
    "block_6  = [(Assume (BinOp (Lit (LInt 10)) Ge (Var 7)))]"
definition block_7
  where
    "block_7  = []"
definition block_8
...
definition block_9
  where
    "block_9  = [(Assume (BinOp (Var 12) Eq (BinOp (Var 5) Sub (Lit (LInt 2)))))]"
definition block_10
  where
    "block_10  = []"
definition block_11
...
definition locals_vdecls :: "(vdecls)"
  where
    "locals_vdecls  = [(0,(TPrim TInt),(None )),(1,(TPrim TInt),(None )),(2,(TPrim TInt),(None )),(3,(TPrim TInt),(None )),(4,(TPrim TInt),(None )),(5,(TPrim TInt),(None )),(6,(TPrim TInt),(None )),(7,(TPrim TInt),(None )),(8,(TPrim TInt),(None )),(10,(TPrim TInt),(None )),(9,(TPrim TInt),(None )),(11,(TPrim TInt),(None )),(12,(TPrim TInt),(None ))]"
