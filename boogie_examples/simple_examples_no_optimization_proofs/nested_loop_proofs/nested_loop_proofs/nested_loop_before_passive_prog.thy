...
definition block_2
  where
    "block_2  = [(Assume (BinOp (Var 1) Gt (Lit (LInt 0)))),(Assign 1 (BinOp (Var 1) Sub (Lit (LInt 1)))),(Assert (BinOp (Var 1) Ge (Lit (LInt 0)))),(Assume (Lit (LBool False)))]"
definition block_3
  where
...
definition block_8
  where
    "block_8  = [(Assign 0 (Lit (LInt 10))),(Assign 1 (Lit (LInt 10))),(Assert (BinOp (Var 0) Ge (Lit (LInt 0))))]"
definition block_9
  where
    "block_9  = []"
definition block_10
