...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_1 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon3_LoopBody vc_i_0 vc_n vc_i_1) \<Longrightarrow> (s' = Magic)))"
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_4 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon3_LoopHead vc_i_0 vc_n vc_i_1) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon3_LoopDone vc_n vc_i_0) \<and> (vc.vc_anon3_LoopBody vc_i_0 vc_n vc_i_1))))))))"
unfolding m_passive_prog.block_4_def vc.vc_anon3_LoopHead_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_5 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 vc_n vc_i_0 vc_i_1) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon3_LoopHead vc_i_0 vc_n vc_i_1)))))))"
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_7 (Normal n_s) s') \<Longrightarrow> ((vc.vc_PreconditionGeneratedEntry vc_n vc_i_0 vc_i_1) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon0 vc_n vc_i_0 vc_i_1)))))))"
