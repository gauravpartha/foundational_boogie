...
imports Boogie_Lang.Semantics Boogie_Lang.Util nested_loop_before_passive_prog
begin
definition block_0
  where
    "block_0  = []"
...
definition block_2
  where
    "block_2  = [(Assume (BinOp (Lit (LInt 0)) Ge (Var 4))),(Assume (BinOp (Var 6) Eq (BinOp (Var 2) Sub (Lit (LInt 1))))),(Assert (BinOp (Var 6) Ge (Lit (LInt 0)))),(Assume (Lit (LBool False)))]"
definition block_3
  where
    "block_3  = [(Assume (BinOp (Var 4) Gt (Lit (LInt 0)))),(Assume (BinOp (Var 5) Eq (BinOp (Var 4) Sub (Lit (LInt 1))))),(Assert (BinOp (Var 5) Ge (Lit (LInt 0)))),(Assume (Lit (LBool False)))]"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Var 4) Ge (Lit (LInt 0))))]"
definition block_5
  where
    "block_5  = [(Assume (BinOp (Var 2) Gt (Lit (LInt 0)))),(Assert (BinOp (Var 3) Ge (Lit (LInt 0))))]"
definition block_6
  where
    "block_6  = [(Assume (BinOp (Var 2) Ge (Lit (LInt 0))))]"
definition block_7
  where
    "block_7  = [(Assert (BinOp (Lit (LInt 10)) Ge (Lit (LInt 0))))]"
definition block_8
  where
    "block_8  = []"
definition block_9
...
definition outEdges
  where
    "outEdges  = [[],[0],[0],[0],[2,3],[4],[1,5],[6],[7],[8]]"
...
lemma outEdges_6:
shows "((nth (out_edges proc_body) 6) = [1,5])"
by (simp add:proc_body_def outEdges_def)
...
definition locals_vdecls :: "(vdecls)"
  where
    "locals_vdecls  = [(0,(TPrim TInt),(None )),(1,(TPrim TInt),(None )),(2,(TPrim TInt),(None )),(3,(TPrim TInt),(None )),(4,(TPrim TInt),(None )),(6,(TPrim TInt),(None )),(5,(TPrim TInt),(None ))]"
...
shows "((Set.inter (set (map fst (append global_data.constants_vdecls global_data.globals_vdecls))) (set (map fst (append nested_loop_passive_prog.params_vdecls nested_loop_passive_prog.locals_vdecls)))) = {})"
