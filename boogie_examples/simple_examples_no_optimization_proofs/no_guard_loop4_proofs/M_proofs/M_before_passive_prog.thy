...
definition block_3
  where
    "block_3  = [(Assume (BinOp (BinOp (Var 0) Sub (Lit (LInt 10))) Gt (Lit (LInt 200)))),(Assign 1 (BinOp (Var 2) Add (Lit (LInt 7)))),(Assume (Lit (LBool False)))]"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Lit (LInt 200)) Ge (BinOp (Var 0) Sub (Lit (LInt 10))))),(Assume (Lit (LBool False)))]"
definition block_5
  where
    "block_5  = []"
definition block_6
...
definition block_8
  where
    "block_8  = [(Assign 0 (BinOp (BinOp (Var 0) Add (Var 1)) Add (Var 2)))]"
definition block_9
  where
