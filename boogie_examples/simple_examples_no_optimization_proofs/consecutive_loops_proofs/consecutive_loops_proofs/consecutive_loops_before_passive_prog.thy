theory consecutive_loops_before_passive_prog
...
definition block_1
  where
    "block_1  = [(Assume (BinOp (Var 0) Gt (Lit (LInt 0)))),(Assign 0 (BinOp (Var 0) Sub (Lit (LInt 1)))),(Assume (Lit (LBool False)))]"
definition block_2
  where
    "block_2  = [(Assume (BinOp (Var 0) Lt (Lit (LInt 0)))),(Assign 0 (BinOp (Var 0) Add (Lit (LInt 1)))),(Assert (BinOp (Var 0) Le (Lit (LInt 0)))),(Assume (Lit (LBool False)))]"
definition block_3
  where
    "block_3  = [(Assert (BinOp (Var 0) Eq (Lit (LInt 0))))]"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Lit (LInt 0)) Le (Var 0)))]"
definition block_5
  where
    "block_5  = [(Havoc 0),(Assume (BinOp (Var 0) Le (Lit (LInt 0))))]"
definition block_6
  where
    "block_6  = [(Assert (BinOp (Var 0) Le (Lit (LInt 0))))]"
definition block_7
  where
