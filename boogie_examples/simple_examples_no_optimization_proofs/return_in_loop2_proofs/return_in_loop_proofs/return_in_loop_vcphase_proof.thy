...
definition vc_anon7_Then
  where
    "vc_anon7_Then x_0 = ((x_0 = (5::int)) \<longrightarrow> (x_0 = (5::int)))"
definition vc_anon4
  where
    "vc_anon4  = True"
definition vc_anon7_Else
  where
    "vc_anon7_Else x_0 = ((x_0 \<noteq> (5::int)) \<longrightarrow> (vc_anon4 ))"
definition vc_anon6_LoopBody
  where
    "vc_anon6_LoopBody x_0 = ((x_0 > (0::int)) \<longrightarrow> ((vc_anon7_Then x_0) \<and> (vc_anon7_Else x_0)))"
definition vc_anon5
  where
    "vc_anon5 x_0 = (x_0 \<noteq> (5::int))"
definition vc_anon6_LoopDone
  where
    "vc_anon6_LoopDone x_0 = (((0::int) \<ge> x_0) \<longrightarrow> (vc_anon5 x_0))"
definition vc_anon0
  where
    "vc_anon0 x_0 = ((vc_anon6_LoopDone x_0) \<and> (vc_anon6_LoopBody x_0))"
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_1 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon7_Then vc_x_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> (n_s' = n_s))))))"
unfolding return_in_loop_passive_prog.block_1_def vc.vc_anon7_Then_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_2 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon4 ) \<Longrightarrow> (s' = Magic)))"
unfolding return_in_loop_passive_prog.block_2_def vc.vc_anon4_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_3 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon7_Else vc_x_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon4 )))))))"
unfolding return_in_loop_passive_prog.block_3_def vc.vc_anon7_Else_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_4 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon6_LoopBody vc_x_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon7_Then vc_x_0) \<and> (vc.vc_anon7_Else vc_x_0))))))))"
unfolding return_in_loop_passive_prog.block_4_def vc.vc_anon6_LoopBody_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_5 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon5 vc_x_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> (n_s' = n_s))))))"
unfolding return_in_loop_passive_prog.block_5_def vc.vc_anon5_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_6 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon6_LoopDone vc_x_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon5 vc_x_0)))))))"
unfolding return_in_loop_passive_prog.block_6_def vc.vc_anon6_LoopDone_def
...
assumes 
"(red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_7 (Normal n_s) s')" and 
"((vc.vc_anon6_LoopDone vc_x_0) \<and> (vc.vc_anon6_LoopBody vc_x_0))"
shows "((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon6_LoopDone vc_x_0) \<and> (vc.vc_anon6_LoopBody vc_x_0))))))"
using assms
unfolding return_in_loop_passive_prog.block_7_def
apply cases
by auto
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> return_in_loop_passive_prog.block_10 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 vc_x_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon6_LoopDone vc_x_0) \<and> (vc.vc_anon6_LoopBody vc_x_0))))))))"
apply (erule red_cmd_list.cases)
using global_assms
unfolding return_in_loop_passive_prog.block_10_def vc.vc_anon0_def
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_magic[OF assms(1) return_in_loop_passive_prog.node_2])
...
"(vc.vc_anon7_Else vc_x_0)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step[OF assms(1) return_in_loop_passive_prog.node_3])
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_2[OF assms(1) return_in_loop_passive_prog.node_5])
apply (erule block_anon5AA0[OF _ assms(2)])
...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append return_in_loop_before_ast_to_cfg_prog.constants_vdecls return_in_loop_before_ast_to_cfg_prog.globals_vdecls),(append return_in_loop_passive_prog.params_vdecls return_in_loop_passive_prog.locals_vdecls)) \<Gamma> [] return_in_loop_passive_prog.proc_body ((Inl 10),(Normal n_s)) (m',s'))" and 
