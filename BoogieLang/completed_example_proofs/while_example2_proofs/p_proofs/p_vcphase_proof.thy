...
definition vc_anon5_LoopBody
  where
    "vc_anon5_LoopBody x_1 x_2 = (((x_1 > (0::int)) \<and> (x_2 = (x_1 - (1::int)))) \<longrightarrow> (x_2 \<ge> (0::int)))"
definition vc_anon6_LoopDone
  where
    "vc_anon6_LoopDone x_3 = (((0::int) \<le> x_3) \<longrightarrow> (x_3 = (0::int)))"
...
definition vc_anon5_LoopDone
  where
    "vc_anon5_LoopDone x_1 x_3 x_4 = (((0::int) \<ge> x_1) \<longrightarrow> ((x_1 \<le> (0::int)) \<and> ((x_1 \<le> (0::int)) \<longrightarrow> (vc_anon6_LoopHead x_3 x_4))))"
definition vc_anon5_LoopHead
  where
    "vc_anon5_LoopHead x_1 x_3 x_4 x_2 = ((x_1 \<ge> (0::int)) \<longrightarrow> ((vc_anon5_LoopDone x_1 x_3 x_4) \<and> (vc_anon5_LoopBody x_1 x_2)))"
definition vc_anon0
  where
    "vc_anon0 x_0 x_1 x_3 x_4 x_2 = ((x_0 \<ge> (0::int)) \<and> ((x_0 \<ge> (0::int)) \<longrightarrow> (vc_anon5_LoopHead x_1 x_3 x_4 x_2)))"
definition vc_PreconditionGeneratedEntry
  where
    "vc_PreconditionGeneratedEntry x_0 x_1 x_3 x_4 x_2 = (vc_anon0 x_0 x_1 x_3 x_4 x_2)"
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_1 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon5_LoopBody vc_x_1 vc_x_2) \<Longrightarrow> (s' = Magic)))"
unfolding p_passive_prog.block_1_def vc.vc_anon5_LoopBody_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_2 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon6_LoopDone vc_x_3) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> (n_s' = n_s))))))"
unfolding p_passive_prog.block_2_def vc.vc_anon6_LoopDone_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_3 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon6_LoopBody vc_x_3 vc_x_4) \<Longrightarrow> (s' = Magic)))"
unfolding p_passive_prog.block_3_def vc.vc_anon6_LoopBody_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_4 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon6_LoopHead vc_x_3 vc_x_4) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon6_LoopDone vc_x_3) \<and> (vc.vc_anon6_LoopBody vc_x_3 vc_x_4))))))))"
unfolding p_passive_prog.block_4_def vc.vc_anon6_LoopHead_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_5 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon5_LoopDone vc_x_1 vc_x_3 vc_x_4) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon6_LoopHead vc_x_3 vc_x_4)))))))"
unfolding p_passive_prog.block_5_def vc.vc_anon5_LoopDone_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_6 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon5_LoopHead vc_x_1 vc_x_3 vc_x_4 vc_x_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon5_LoopDone vc_x_1 vc_x_3 vc_x_4) \<and> (vc.vc_anon5_LoopBody vc_x_1 vc_x_2))))))))"
unfolding p_passive_prog.block_6_def vc.vc_anon5_LoopHead_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_7 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 vc_x_0 vc_x_1 vc_x_3 vc_x_4 vc_x_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon5_LoopHead vc_x_1 vc_x_3 vc_x_4 vc_x_2)))))))"
unfolding p_passive_prog.block_7_def vc.vc_anon0_def
...
lemma block_0:
assumes 
"(red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_8 (Normal n_s) s')" and 
"(vc.vc_anon0 vc_x_0 vc_x_1 vc_x_3 vc_x_4 vc_x_2)"
shows "((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon0 vc_x_0 vc_x_1 vc_x_3 vc_x_4 vc_x_2)))))"
using assms
unfolding p_passive_prog.block_8_def
apply cases
by auto

lemma block_PreconditionGeneratedEntry:
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.block_9 (Normal n_s) s') \<Longrightarrow> ((vc.vc_PreconditionGeneratedEntry vc_x_0 vc_x_1 vc_x_3 vc_x_4 vc_x_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon0 vc_x_0 vc_x_1 vc_x_3 vc_x_4 vc_x_2)))))))"
apply (erule red_cmd_list.cases)
using global_assms
unfolding p_passive_prog.block_9_def vc.vc_PreconditionGeneratedEntry_def
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_magic[OF assms(1) p_passive_prog.node_3])
...
"(vc.vc_anon5_LoopHead vc_x_1 vc_x_3 vc_x_4 vc_x_2)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
...
lemma cfg_block_0:
assumes 
"(red_cfg_multi A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.proc_body ((Inl 8),(Normal n_s)) (m',s'))" and 
"(vc.vc_anon0 vc_x_0 vc_x_1 vc_x_3 vc_x_4 vc_x_2)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step[OF assms(1) p_passive_prog.node_8])
apply (erule block_0[OF _ assms(2)])
apply ((simp add:p_passive_prog.outEdges_8))
apply (erule member_elim, simp)
...
assumes 
"(red_cfg_multi A M \<Lambda> \<Gamma> \<Omega> p_passive_prog.proc_body ((Inl 9),(Normal n_s)) (m',s'))" and 
"(vc.vc_PreconditionGeneratedEntry vc_x_0 vc_x_1 vc_x_3 vc_x_4 vc_x_2)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step[OF assms(1) p_passive_prog.node_9])
apply (erule block_PreconditionGeneratedEntry[OF _ assms(2)])
apply ((simp add:p_passive_prog.outEdges_9))
apply (erule member_elim, simp)
...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append p_passive_prog.params_vdecls p_passive_prog.locals_vdecls)) \<Gamma> [] p_passive_prog.proc_body ((Inl 9),(Normal n_s)) (m',s'))" and 
...
apply (simp only:state_typ_wf_def)
apply (erule allE, erule allE, erule impE, rule map_of_lookup_vdecls_ty[OF p_passive_prog.m_x_2])
apply (subst lookup_var_local[OF p_passive_prog.m_x_2])+
by (fastforce dest: tint_intv tbool_boolv)
...
apply (simp only:state_typ_wf_def)
apply (erule allE, erule allE, erule impE, rule map_of_lookup_vdecls_ty[OF p_passive_prog.m_x_3])
apply (subst lookup_var_local[OF p_passive_prog.m_x_3])+
by (fastforce dest: tint_intv tbool_boolv)
...
apply (simp only:state_typ_wf_def)
apply (erule allE, erule allE, erule impE, rule map_of_lookup_vdecls_ty[OF p_passive_prog.m_x_4])
apply (subst lookup_var_local[OF p_passive_prog.m_x_4])+
by (fastforce dest: tint_intv tbool_boolv)
