...
fixes A :: "(('a)absval_ty_fun)" and \<Lambda> :: "(var_context)" and \<Gamma> :: "(('a)fun_interp)" and n_s :: "(('a)nstate)" and vc_x :: "int" and vc_y :: "int" and vc_z :: "int" and vc_x_0 :: "int" and vc_y_0 :: "int" and vc_z_0 :: "int" and vc_y_1 :: "int" and vc_x_1 :: "int" and vc_x_2 :: "int" and vc_x_3 :: "int" and vc_x_4 :: "int" and vc_y_2 :: "int"
assumes 
...
G6: "((lookup_var \<Lambda> n_s 6) = (Some (IntV vc_y_1)))" and 
G7: "((lookup_var \<Lambda> n_s 7) = (Some (IntV vc_x_1)))" and 
G8: "((lookup_var \<Lambda> n_s 8) = (Some (IntV vc_x_2)))" and 
G9: "((lookup_var \<Lambda> n_s 9) = (Some (IntV vc_x_3)))" and 
G10: "((lookup_var \<Lambda> n_s 10) = (Some (IntV vc_x_4)))" and 
...
assumes 
"(red_cmd_list A M \<Lambda> \<Gamma> \<Omega> M_passive_prog.block_1 (Normal n_s) s')"
shows "((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> (n_s' = n_s))))"
using assms
unfolding M_passive_prog.block_1_def
apply cases
by auto
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> M_passive_prog.block_3 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 ) \<Longrightarrow> (s' = Magic)))"
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> M_passive_prog.block_4 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 ) \<Longrightarrow> (s' = Magic)))"
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> M_passive_prog.block_8 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 ) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon0 ) \<and> (vc.vc_anon0 ))))))))"
unfolding M_passive_prog.block_8_def vc.vc_anon0_def
...
assumes 
"(red_cmd_list A M \<Lambda> \<Gamma> \<Omega> M_passive_prog.block_9 (Normal n_s) s')" and 
"(vc.vc_anon0 )"
shows "((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon0 )))))"
using assms
unfolding M_passive_prog.block_9_def
apply cases
by auto
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> M_passive_prog.block_12 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 ) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon0 )))))))"
apply (erule red_cmd_list.cases)
using global_assms
unfolding M_passive_prog.block_12_def vc.vc_anon0_def
...
assumes 
"(red_cfg_multi A M \<Lambda> \<Gamma> \<Omega> M_passive_prog.proc_body ((Inl 1),(Normal n_s)) (m',s'))"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
...
by (erule block_anon7_LoopBodyAA0[OF _ assms(2)])
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_magic[OF assms(1) M_passive_prog.node_3])
by (erule block_anon8_ThenAA0[OF _ assms(2)])
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_magic[OF assms(1) M_passive_prog.node_4])
by (erule block_anon8_ElseAA0[OF _ assms(2)])
...
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step[OF assms(1) M_passive_prog.node_9])
...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append M_before_ast_to_cfg_prog.constants_vdecls M_before_ast_to_cfg_prog.globals_vdecls),(append M_passive_prog.params_vdecls M_passive_prog.locals_vdecls)) \<Gamma> [] M_passive_prog.proc_body ((Inl 12),(Normal n_s)) (m',s'))" and 
VC: "(\<And> (vc_x::int) (vc_y::int) (vc_z::int) (vc_x_0::int) (vc_y_0::int) (vc_z_0::int) (vc_y_1::int) (vc_x_1::int) (vc_x_2::int) (vc_x_3::int) (vc_x_4::int) (vc_y_2::int). (vc.vc_anon0 ))" and 
...
by (fastforce dest: tint_intv tbool_boolv)
from ParamsLocal have sc_y_1:"(((lookup_var ?\<Lambda> n_s 6) = (Some (IntV (convert_val_to_int (the (lookup_var ?\<Lambda> n_s 6)))))) \<and> (((type_of_val A) (the (lookup_var ?\<Lambda> n_s 6))) = (TPrim TInt)))"
apply (simp only:state_typ_wf_def)
...
by (fastforce dest: tint_intv tbool_boolv)
from ParamsLocal have sc_x_1:"(((lookup_var ?\<Lambda> n_s 7) = (Some (IntV (convert_val_to_int (the (lookup_var ?\<Lambda> n_s 7)))))) \<and> (((type_of_val A) (the (lookup_var ?\<Lambda> n_s 7))) = (TPrim TInt)))"
apply (simp only:state_typ_wf_def)
...
by (fastforce dest: tint_intv tbool_boolv)
from ParamsLocal have sc_x_3:"(((lookup_var ?\<Lambda> n_s 9) = (Some (IntV (convert_val_to_int (the (lookup_var ?\<Lambda> n_s 9)))))) \<and> (((type_of_val A) (the (lookup_var ?\<Lambda> n_s 9))) = (TPrim TInt)))"
apply (simp only:state_typ_wf_def)
...
by (fastforce dest: tint_intv tbool_boolv)
from ParamsLocal have sc_x_4:"(((lookup_var ?\<Lambda> n_s 10) = (Some (IntV (convert_val_to_int (the (lookup_var ?\<Lambda> n_s 10)))))) \<and> (((type_of_val A) (the (lookup_var ?\<Lambda> n_s 10))) = (TPrim TInt)))"
apply (simp only:state_typ_wf_def)
