...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append consecutive_ifs_passive_prog.params_vdecls consecutive_ifs_passive_prog.locals_vdecls)) \<Gamma> [] consecutive_ifs_passive_prog.proc_body ((Inl 8),(Normal n_s)) (m',s'))" and 
...
let ?\<Lambda> = "((append global_data.constants_vdecls global_data.globals_vdecls),(append consecutive_ifs_passive_prog.params_vdecls consecutive_ifs_passive_prog.locals_vdecls))"
