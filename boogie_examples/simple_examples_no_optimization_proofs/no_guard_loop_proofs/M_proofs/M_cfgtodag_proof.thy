...
shows "(mods_contained_in (set [0]) M_before_cfg_to_dag_prog.block_4)"
...
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] M_before_passive_prog.block_1 ns2 s' True)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_4_def M_before_passive_prog.block_1_def
...
IH_anon9_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body [0] [] M_before_ast_to_cfg_prog.post ns1 s' 3 m' j)"
...
lemma Mods_anon6:
shows "(mods_contained_in (set [0,1]) M_before_cfg_to_dag_prog.block_9)"
unfolding M_before_cfg_to_dag_prog.block_9_def
by simp
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_9_def M_before_passive_prog.block_2_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
IH_anon8_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body [0,1] [] M_before_ast_to_cfg_prog.post ns1 s' 1 m' j)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
apply (rule cfg_dag_helper_2[OF Red _ _ DagVerifies DagAssms])
...
lemma Mods_anon10_Then:
shows "(mods_contained_in (set [0,1]) M_before_cfg_to_dag_prog.block_7)"
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_7_def M_before_passive_prog.block_3_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
apply (assumption+)
apply (rule block_anon10_Then)
apply (assumption+)
apply (rule Mods_anon10_Then)
...
using IH_anon8_LoopHead apply simp
apply simp
apply (rule dag_lemma_assms_state_wt_1[OF DagAssms])
by (simp add: member_rec(2))


lemma Mods_anon10_Else:
shows "(mods_contained_in (set [0,1]) M_before_cfg_to_dag_prog.block_8)"
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_8_def M_before_passive_prog.block_4_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
apply (assumption+)
apply (rule block_anon10_Else)
apply (assumption+)
apply (rule Mods_anon10_Else)
...
lemma Mods_anon3:
shows "(mods_contained_in (set [0,1]) M_before_cfg_to_dag_prog.block_6)"
...
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] M_before_passive_prog.block_5 ns2 s' False)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_6_def M_before_passive_prog.block_5_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
apply ((simp add:member_rec(1)))
apply (rule cfg_block_anon10_Then)
apply simp
unfolding dag_lemma_assms_def
apply (intro conjI)
apply simp
...
apply ((simp add:M_before_passive_prog.outEdges_5))
apply ((simp add:member_rec(1)))
apply (rule cfg_block_anon10_Else)
apply simp
unfolding dag_lemma_assms_def
apply (intro conjI)
apply simp
...
shows "(mods_contained_in (set [0,1]) M_before_cfg_to_dag_prog.block_5)"
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_5_def M_before_passive_prog.block_6_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
shows "(mods_contained_in (set [0,1]) M_before_cfg_to_dag_prog.block_2)"
...
lemma block_anon7:
assumes 
"(red_cmd_list A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.block_11 (Normal ns1) s')" and 
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_11_def M_before_passive_prog.block_9_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
assumes 
Red: "(red_cfg_k_step A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body ((Inl 11),(Normal ns1)) j (m',s'))" and 
DagAssms: "(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)" and 
...
apply (rule DagAssms)
apply (erule block_anon7)
apply assumption+
apply (rule M_before_cfg_to_dag_prog.outEdges_11)
apply (rule M_before_passive_prog.outEdges_9)
...
assumes 
"(red_cmd_list A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.block_10 (Normal ns1) s')" and 
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_10_def M_before_passive_prog.block_10_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
assumes 
Red: "(red_cfg_k_step A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body ((Inl 10),(Normal ns1)) j (m',s'))" and 
DagAssms: "(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)" and 
...
apply (rule M_before_cfg_to_dag_prog.node_10)
...
shows "(mods_contained_in (set [0,1]) M_before_cfg_to_dag_prog.block_1)"
...
"(\<And> s2'. ((red_cmd_list A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.block_11 (Normal ns2) s2') \<Longrightarrow> (s2' \<noteq> Failure)))" and 
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [0,1] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] M_before_passive_prog.block_11 ns2 s' False)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_1_def M_before_passive_prog.block_11_def
apply cfg_dag_rel_tac_single+
apply simp
apply ((simp add:M_before_ast_to_cfg_prog.l_x(1)))
...
DagVerifies: "(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 11),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
using Red DagAssms
proof (induction j arbitrary: ns1 rule: less_induct)
case (less j)
...
apply (rule M_before_passive_prog.node_11)
apply (assumption+)
...
"(\<And> s2'. ((red_cmd_list A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.block_12 (Normal ns2) s2') \<Longrightarrow> (s2' \<noteq> Failure)))" and 
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] M_before_passive_prog.block_12 ns2 s' False)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_0_def M_before_passive_prog.block_12_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
DagAssms: "(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)" and 
DagVerifies: "(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 12),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
apply (rule cfg_dag_helper_1[OF Red _ _ DagVerifies DagAssms])
...
apply ((simp add:M_before_passive_prog.outEdges_12))
apply ((simp add:member_rec(1)))
...
lemma cfg_block_0:
assumes 
"(\<forall> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 13),(Normal ns2)) (m2',s2')) \<longrightarrow> (s2' \<noteq> Failure)))" and 
"(nstate_same_on \<Lambda>1 ns1 ns2 {})" and 
"(state_well_typed A \<Lambda>1 [] ns1)" and 
"(state_well_typed A \<Lambda>1 [] ns2)" and 
"((\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 12),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure))) \<Longrightarrow> R)"
shows "R"
using assms
apply (rule cfg_dag_empty_propagate_helper)
apply (assumption, simp)
apply ((simp add:M_before_passive_prog.outEdges_13))
by ((simp add:M_before_passive_prog.node_13 M_before_passive_prog.block_13_def))
...
"(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 14),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))" and 
"(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 M_before_ast_to_cfg_prog.pres)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
apply (rule cfg_dag_helper_entry)
apply (rule M_before_passive_prog.node_14)
apply (erule assms(3))
apply (rule assms(2))
unfolding M_before_passive_prog.block_14_def
apply (rule assume_pres_normal[where ?es=M_before_ast_to_cfg_prog.pres])
apply (rule assms(4))
unfolding M_before_ast_to_cfg_prog.pres_def
apply simp
apply (rule M_before_passive_prog.outEdges_14)
apply ((simp add:M_before_passive_prog.node_13 M_before_passive_prog.block_13_def))
apply (rule M_before_passive_prog.outEdges_13)
