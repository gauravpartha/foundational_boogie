...
"((R 0) = (Some (Inl 1)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [2])) (update_nstate_rel R [(0,(Inr (LInt 10))),(0,(Inl 2))]) R_old p_passive_prog.block_1 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"(passive_lemma_assms A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> [2] R R_old U0 D0 n_s)" and 
"((R 0) = (Some (Inl 1)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [2])) (update_nstate_rel R [(0,(Inr (LInt 1))),(0,(Inl 2))]) R_old p_passive_prog.block_2 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [1])) (update_nstate_rel R [(0,(Inl 1))]) R_old p_passive_prog.block_3 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm p_before_passive_prog.node_0},@{thm p_before_passive_prog.outEdges_0}) (@{thm p_passive_prog.node_0},@{thm p_passive_prog.outEdges_0}) @{thm block_anon3} [] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm p_before_passive_prog.node_1},@{thm p_before_passive_prog.outEdges_1}) (@{thm p_passive_prog.node_1},@{thm p_passive_prog.outEdges_1}) @{thm block_anon4_Then} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm p_before_passive_prog.node_2},@{thm p_before_passive_prog.outEdges_2}) (@{thm p_passive_prog.node_2},@{thm p_passive_prog.outEdges_2}) @{thm block_anon4_Else} [
@{thm cfg_block_anon3}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_3},@{thm p_before_passive_prog.outEdges_3}) (@{thm p_passive_prog.node_3},@{thm p_passive_prog.outEdges_3}) @{thm block_anon0} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_4},@{thm p_before_passive_prog.outEdges_4}) (@{thm p_passive_prog.node_4},@{thm p_passive_prog.outEdges_4}) @{thm block_0} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm p_before_passive_prog.node_5},@{thm p_before_passive_prog.outEdges_5}) (@{thm p_passive_prog.node_5},@{thm p_passive_prog.outEdges_5}) @{thm block_PreconditionGeneratedEntry} [
...
assumes 
Red: "(red_cfg_multi A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append p_before_cfg_to_dag_prog.params_vdecls p_before_cfg_to_dag_prog.locals_vdecls)) \<Gamma> [] p_before_passive_prog.proc_body ((Inl 5),(Normal ns)) (m',s'))" and 
...
proof
assume A1: "(s' = Failure)"
have "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> [] p_passive_prog.proc_body u (Inl 5)))))"
...
with A1 obtain u mp' where uElem: "(Set.member u U0)" and AredPassive:"(red_cfg_multi A M \<Lambda>2 \<Gamma> [] p_passive_prog.proc_body ((Inl 5),(Normal u)) (mp',Failure))"
