theory if_example_no_else_branch_before_ast_to_cfg_prog
imports Boogie_Lang.Ast Boogie_Lang.Semantics Boogie_Lang.TypeSafety Boogie_Lang.Util "../global_data"
begin
definition bigblock_0
  where
    "bigblock_0  = (BigBlock (None ) [(Havoc 0)] (Some (ParsedIf (Some (BinOp (Var 0) Gt (Lit (LInt 5)))) [(BigBlock (None ) [(Assign 0 (Lit (LInt 10)))] (None ) (None ))] [(BigBlock (None ) [] (None ) (None ))])) (None ))"
...
definition bigblock_3
  where
    "bigblock_3  = (BigBlock (None ) [] (Some (ParsedIf (Some (BinOp (Var 0) Le (Lit (LInt 5)))) [(BigBlock (None ) [(Assign 0 (Lit (LInt 1)))] (None ) (None ))] [(BigBlock (None ) [] (None ) (None ))])) (None ))"
...
definition bigblock_6
  where
    "bigblock_6  = (BigBlock (None ) [(Assert (BinOp (Var 0) Gt (Lit (LInt 0))))] (None ) (None ))"
definition cont_6
  where
    "cont_6  = KStop"
definition cont_3
...
definition cont_4
  where
    "cont_4  = (KSeq bigblock_6 cont_6)"
definition cont_5
  where
    "cont_5  = (KSeq bigblock_6 cont_6)"
definition cont_0
  where
...
shows "(((map fst (append if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls)))) \<le> 0))"
...
lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls) )"
unfolding if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls) )"
unfolding if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls_def
by simp

lemma params_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) if_example_no_else_branch_before_ast_to_cfg_prog.params_vdecls) )"
unfolding if_example_no_else_branch_before_ast_to_cfg_prog.params_vdecls_def
by simp

lemma locals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) if_example_no_else_branch_before_ast_to_cfg_prog.locals_vdecls) )"
unfolding if_example_no_else_branch_before_ast_to_cfg_prog.locals_vdecls_def
by simp

lemma var_context_wf:
shows "(\<forall> x \<tau>. (((lookup_var_ty ((append if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls),(append if_example_no_else_branch_before_ast_to_cfg_prog.params_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.locals_vdecls)) x) = (Some \<tau>)) \<longrightarrow> ((wf_ty 0) \<tau>)))"
apply (rule lookup_ty_pred_2)
by ((simp_all add:consts_wf globals_wf params_wf locals_wf))

lemma m_x:
shows "((map_of (append if_example_no_else_branch_before_ast_to_cfg_prog.params_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.locals_vdecls) 0) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma l_x:
shows "((lookup_var_decl ((append if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls),(append if_example_no_else_branch_before_ast_to_cfg_prog.params_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.locals_vdecls)) 0) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append if_example_no_else_branch_before_ast_to_cfg_prog.constants_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.globals_vdecls),(append if_example_no_else_branch_before_ast_to_cfg_prog.params_vdecls if_example_no_else_branch_before_ast_to_cfg_prog.locals_vdecls)) 0) = (Some (TPrim TInt)))"
