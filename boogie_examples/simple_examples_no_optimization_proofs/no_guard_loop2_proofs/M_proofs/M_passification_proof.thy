...
"((R 0) = (Some (Inl 8)))" and 
"((R 1) = (Some (Inl 7)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [10])) (update_nstate_rel R [(0,(Inl 10))]) R_old M_passive_prog.block_2 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 1) = (Some (Inl 1)))" and 
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [11])) (update_nstate_rel R [(0,(Inl 11))]) R_old M_passive_prog.block_3 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 0) = (Some (Inl 8)))" and 
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [9])) (update_nstate_rel R [(1,(Inl 9))]) R_old M_passive_prog.block_4 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 2) = (Some (Inl 5)))" and 
"((R 1) = (Some (Inl 7)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old M_passive_prog.block_7 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 2) = (Some (Inl 5)))" and 
"((R 1) = (Some (Inl 7)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old M_passive_prog.block_9 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [6,7])) (update_nstate_rel R [(0,(Inl 6)),(1,(Inl 7))]) R_old M_passive_prog.block_10 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [3,4,5])) (update_nstate_rel R [(0,(Inl 3)),(1,(Inl 4)),(2,(Inl 5))]) R_old M_passive_prog.block_11 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm M_before_passive_prog.node_1},@{thm M_before_passive_prog.outEdges_1}) (@{thm M_passive_prog.node_1},@{thm M_passive_prog.outEdges_1}) @{thm block_anon7_LoopDone} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_2},@{thm M_before_passive_prog.outEdges_2}) (@{thm M_passive_prog.node_2},@{thm M_passive_prog.outEdges_2}) @{thm block_anon8_LoopBody} [
@{thm cfg_block_GeneratedUnifiedExit}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_3},@{thm M_before_passive_prog.outEdges_3}) (@{thm M_passive_prog.node_3},@{thm M_passive_prog.outEdges_3}) @{thm block_anon6} [
@{thm cfg_block_GeneratedUnifiedExit}] 1\<close>))

lemma cfg_block_anon9_Then:
assumes 
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_4},@{thm M_before_passive_prog.outEdges_4}) (@{thm M_passive_prog.node_4},@{thm M_passive_prog.outEdges_4}) @{thm block_anon9_Then} [
@{thm cfg_block_anon6}] 1\<close>))

lemma cfg_block_anon9_Else:
assumes 
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_5},@{thm M_before_passive_prog.outEdges_5}) (@{thm M_passive_prog.node_5},@{thm M_passive_prog.outEdges_5}) @{thm block_anon9_Else} [
@{thm cfg_block_anon6}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_6},@{thm M_before_passive_prog.outEdges_6}) (@{thm M_passive_prog.node_6},@{thm M_passive_prog.outEdges_6}) @{thm block_anon3} [
@{thm cfg_block_anon9_Then}, 
@{thm cfg_block_anon9_Else}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_7},@{thm M_before_passive_prog.outEdges_7}) (@{thm M_passive_prog.node_7},@{thm M_passive_prog.outEdges_7}) @{thm block_anon8_LoopDone} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_8},@{thm M_before_passive_prog.outEdges_8}) (@{thm M_passive_prog.node_8},@{thm M_passive_prog.outEdges_8}) @{thm block_anon8_LoopHead} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_9},@{thm M_before_passive_prog.outEdges_9}) (@{thm M_passive_prog.node_9},@{thm M_passive_prog.outEdges_9}) @{thm block_anon7_LoopBody} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_10},@{thm M_before_passive_prog.outEdges_10}) (@{thm M_passive_prog.node_10},@{thm M_passive_prog.outEdges_10}) @{thm block_anon7_LoopHead} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm M_before_passive_prog.node_11},@{thm M_before_passive_prog.outEdges_11}) (@{thm M_passive_prog.node_11},@{thm M_passive_prog.outEdges_11}) @{thm block_anon0} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm M_before_passive_prog.node_12},@{thm M_before_passive_prog.outEdges_12}) (@{thm M_passive_prog.node_12},@{thm M_passive_prog.outEdges_12}) @{thm block_0} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm M_before_passive_prog.node_13},@{thm M_before_passive_prog.outEdges_13}) (@{thm M_passive_prog.node_13},@{thm M_passive_prog.outEdges_13}) @{thm block_PreconditionGeneratedEntry} [
...
assumes 
Red: "(red_cfg_multi A M ((append M_before_ast_to_cfg_prog.constants_vdecls M_before_ast_to_cfg_prog.globals_vdecls),(append M_before_ast_to_cfg_prog.params_vdecls M_before_ast_to_cfg_prog.locals_vdecls)) \<Gamma> [] M_before_passive_prog.proc_body ((Inl 13),(Normal ns)) (m',s'))" and 
VC: "(\<And> (vc_x::int) (vc_y::int) (vc_z::int) (vc_x_0::int) (vc_y_0::int) (vc_z_0::int) (vc_x_1::int) (vc_y_1::int) (vc_x_2::int) (vc_x_3::int) (vc_y_2::int) (vc_x_4::int). (vc.vc_anon0 ))" and 
...
proof
assume A1: "(s' = Failure)"
have "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> [] M_passive_prog.proc_body u (Inl 13)))))"
...
with A1 obtain u mp' where uElem: "(Set.member u U0)" and AredPassive:"(red_cfg_multi A M \<Lambda>2 \<Gamma> [] M_passive_prog.proc_body ((Inl 13),(Normal u)) (mp',Failure))"
