...
definition block_2
  where
    "block_2  = [(Assert (BinOp (Var 0) Eq (Lit (LInt 0))))]"
definition outEdges
  where
    "outEdges  = [[1],[2],[]]"
...
shows "(((map fst (append empty_generic_block_before_cfg_to_dag_prog.constants_vdecls empty_generic_block_before_cfg_to_dag_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append empty_generic_block_before_cfg_to_dag_prog.constants_vdecls empty_generic_block_before_cfg_to_dag_prog.globals_vdecls)))) \<le> 0))"
unfolding empty_generic_block_before_cfg_to_dag_prog.constants_vdecls_def empty_generic_block_before_cfg_to_dag_prog.globals_vdecls_def
by simp

lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append empty_generic_block_before_cfg_to_dag_prog.constants_vdecls empty_generic_block_before_cfg_to_dag_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
shows "((Set.inter (set (map fst (append empty_generic_block_before_cfg_to_dag_prog.constants_vdecls empty_generic_block_before_cfg_to_dag_prog.globals_vdecls))) (set (map fst (append empty_generic_block_before_cfg_to_dag_prog.params_vdecls empty_generic_block_before_cfg_to_dag_prog.locals_vdecls)))) = {})"
unfolding empty_generic_block_before_cfg_to_dag_prog.constants_vdecls_def empty_generic_block_before_cfg_to_dag_prog.globals_vdecls_def
by simp
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) empty_generic_block_before_cfg_to_dag_prog.constants_vdecls) )"
unfolding empty_generic_block_before_cfg_to_dag_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) empty_generic_block_before_cfg_to_dag_prog.globals_vdecls) )"
