theory consecutive_ifs_before_passive_prog
imports Boogie_Lang.Semantics Boogie_Lang.Util consecutive_ifs_before_cfg_to_dag_prog
begin
definition block_0
  where
    "block_0  = []"
...
definition block_2
  where
    "block_2  = [(Assign 0 (UnOp UMinus (Lit (LInt 1))))]"
definition block_3
  where
    "block_3  = []"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Var 0) Gt (Lit (LInt 0)))),(Assign 0 (Lit (LInt 5)))]"
definition block_5
  where
