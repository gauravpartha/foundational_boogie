...
imports Boogie_Lang.Semantics Boogie_Lang.Util no_inv_loop_before_passive_prog
begin
definition block_0
  where
    "block_0  = []"
...
shows "((Set.inter (set (map fst (append global_data.constants_vdecls global_data.globals_vdecls))) (set (map fst (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)))) = {})"
