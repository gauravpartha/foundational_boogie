...
"((R 0) = (Some (Inl 8)))" and 
"((R 1) = (Some (Inl 7)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [10])) (update_nstate_rel R [(0,(Inl 10))]) R_old M_passive_prog.block_1 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 1) = (Some (Inl 1)))" and 
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [11])) (update_nstate_rel R [(0,(Inl 11))]) R_old M_passive_prog.block_2 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 0) = (Some (Inl 8)))" and 
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [9])) (update_nstate_rel R [(1,(Inl 9))]) R_old M_passive_prog.block_3 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 1) = (Some (Inl 7)))" and 
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old M_passive_prog.block_4 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 2) = (Some (Inl 5)))" and 
"((R 1) = (Some (Inl 7)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [8])) (update_nstate_rel R [(0,(Inl 8))]) R_old M_passive_prog.block_7 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 2) = (Some (Inl 5)))" and 
"((R 1) = (Some (Inl 7)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old M_passive_prog.block_8 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [12])) (update_nstate_rel R [(2,(Inl 12))]) R_old M_passive_prog.block_9 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
unfolding M_before_passive_prog.block_9_def M_passive_prog.block_9_def
apply (passive_rel_tac R_def: assms(3-))
apply (unfold type_rel_def, simp, (intro conjI)?)
apply ((simp add:M_before_ast_to_cfg_prog.l_z(2) M_passive_prog.l_z_1(2)))
by simp
...
"(passive_lemma_assms A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> [] R R_old U0 D0 n_s)" and 
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old M_passive_prog.block_10 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
"((R 2) = (Some (Inl 5)))"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [6,7])) (update_nstate_rel R [(0,(Inl 6)),(1,(Inl 7))]) R_old M_passive_prog.block_11 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [3,4,5])) (update_nstate_rel R [(0,(Inl 3)),(1,(Inl 4)),(2,(Inl 5))]) R_old M_passive_prog.block_12 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
...
lemma block_0:
assumes 
"(red_cmd_list A M \<Lambda>1 \<Gamma> \<Omega> M_before_passive_prog.block_13 (Normal n_s) s')" and 
"(passive_lemma_assms A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> [] R R_old U0 D0 n_s)"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old M_passive_prog.block_13 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
unfolding M_before_passive_prog.block_13_def M_passive_prog.block_13_def
apply (passive_rel_tac)
apply (unfold type_rel_def, simp, (intro conjI)?)
by simp
...
assumes 
"(red_cmd_list A M \<Lambda>1 \<Gamma> \<Omega> M_before_passive_prog.block_14 (Normal n_s) s')" and 
"(passive_lemma_assms A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> [] R R_old U0 D0 n_s)"
shows "(passive_block_conclusion A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> U0 (Set.union D0 (set [])) (update_nstate_rel R []) R_old M_passive_prog.block_14 s')"
apply (rule passification_block_lemma_compact[OF assms(1-2)])
unfolding M_before_passive_prog.block_14_def M_passive_prog.block_14_def
apply (passive_rel_tac)
apply (unfold type_rel_def, simp, (intro conjI)?)
by simp
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_1},@{thm M_before_passive_prog.outEdges_1}) (@{thm M_passive_prog.node_1},@{thm M_passive_prog.outEdges_1}) @{thm block_anon9_LoopBody} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_2},@{thm M_before_passive_prog.outEdges_2}) (@{thm M_passive_prog.node_2},@{thm M_passive_prog.outEdges_2}) @{thm block_anon6} [
@{thm cfg_block_GeneratedUnifiedExit}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_3},@{thm M_before_passive_prog.outEdges_3}) (@{thm M_passive_prog.node_3},@{thm M_passive_prog.outEdges_3}) @{thm block_anon10_Then} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_4},@{thm M_before_passive_prog.outEdges_4}) (@{thm M_passive_prog.node_4},@{thm M_passive_prog.outEdges_4}) @{thm block_anon10_Else} [
@{thm cfg_block_anon6}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_5},@{thm M_before_passive_prog.outEdges_5}) (@{thm M_passive_prog.node_5},@{thm M_passive_prog.outEdges_5}) @{thm block_anon3} [
@{thm cfg_block_anon10_Then}, 
@{thm cfg_block_anon10_Else}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_6},@{thm M_before_passive_prog.outEdges_6}) (@{thm M_passive_prog.node_6},@{thm M_passive_prog.outEdges_6}) @{thm block_anon9_LoopDone} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_7},@{thm M_before_passive_prog.outEdges_7}) (@{thm M_passive_prog.node_7},@{thm M_passive_prog.outEdges_7}) @{thm block_anon9_LoopHead} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_8},@{thm M_before_passive_prog.outEdges_8}) (@{thm M_passive_prog.node_8},@{thm M_passive_prog.outEdges_8}) @{thm block_anon8_LoopBody} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_9},@{thm M_before_passive_prog.outEdges_9}) (@{thm M_passive_prog.node_9},@{thm M_passive_prog.outEdges_9}) @{thm block_anon7} [
@{thm cfg_block_GeneratedUnifiedExit}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_10},@{thm M_before_passive_prog.outEdges_10}) (@{thm M_passive_prog.node_10},@{thm M_passive_prog.outEdges_10}) @{thm block_anon8_LoopDone} [
@{thm cfg_block_anon7}] 1\<close>))
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} @{thms assms(3-)} (@{thm M_before_passive_prog.node_11},@{thm M_before_passive_prog.outEdges_11}) (@{thm M_passive_prog.node_11},@{thm M_passive_prog.outEdges_11}) @{thm block_anon8_LoopHead} [
...
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm M_before_passive_prog.node_12},@{thm M_before_passive_prog.outEdges_12}) (@{thm M_passive_prog.node_12},@{thm M_passive_prog.outEdges_12}) @{thm block_anon0} [
@{thm cfg_block_anon8_LoopHead}] 1\<close>))

lemma cfg_block_0:
assumes 
"(red_cfg_multi A M \<Lambda>1 \<Gamma> \<Omega> M_before_passive_prog.proc_body ((Inl 13),(Normal n_s)) (m',s'))" and 
"(passive_lemma_assms_2 A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> 3 R R_old U0 D0 n_s)"
shows "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> \<Omega> M_passive_prog.proc_body u (Inl 13)))))"
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm M_before_passive_prog.node_13},@{thm M_before_passive_prog.outEdges_13}) (@{thm M_passive_prog.node_13},@{thm M_passive_prog.outEdges_13}) @{thm block_0} [
@{thm cfg_block_anon0}] 1\<close>))

lemma cfg_block_PreconditionGeneratedEntry:
assumes 
"(red_cfg_multi A M \<Lambda>1 \<Gamma> \<Omega> M_before_passive_prog.proc_body ((Inl 14),(Normal n_s)) (m',s'))" and 
"(passive_lemma_assms_2 A M \<Lambda>1 \<Lambda>2 \<Gamma> \<Omega> 3 R R_old U0 D0 n_s)"
shows "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> \<Omega> M_passive_prog.proc_body u (Inl 14)))))"
by ((tactic \<open> cfg_lemma_tac @{context} @{thm assms(1)} @{thm assms(2)} [] (@{thm M_before_passive_prog.node_14},@{thm M_before_passive_prog.outEdges_14}) (@{thm M_passive_prog.node_14},@{thm M_passive_prog.outEdges_14}) @{thm block_PreconditionGeneratedEntry} [
...
assumes 
Red: "(red_cfg_multi A M ((append M_before_ast_to_cfg_prog.constants_vdecls M_before_ast_to_cfg_prog.globals_vdecls),(append M_before_ast_to_cfg_prog.params_vdecls M_before_ast_to_cfg_prog.locals_vdecls)) \<Gamma> [] M_before_passive_prog.proc_body ((Inl 14),(Normal ns)) (m',s'))" and 
...
proof
assume A1: "(s' = Failure)"
have "((s' = Failure) \<longrightarrow> (\<exists> u. ((Set.member u U0) \<and> (passive_sim_cfg_fail A M \<Lambda>2 \<Gamma> [] M_passive_prog.proc_body u (Inl 14)))))"
...
with A1 obtain u mp' where uElem: "(Set.member u U0)" and AredPassive:"(red_cfg_multi A M \<Lambda>2 \<Gamma> [] M_passive_prog.proc_body ((Inl 14),(Normal u)) (mp',Failure))"
