...
definition vc_anon3
  where
    "vc_anon3 x_1 x_0 = ((x_1 = (x_0 - (1::int))) \<longrightarrow> (x_1 \<ge> (0::int)))"
definition vc_anon5_LoopDone
  where
    "vc_anon5_LoopDone y_1 x_1 x_0 = (((0::int) \<ge> y_1) \<longrightarrow> (vc_anon3 x_1 x_0))"
...
fixes A :: "(('a)absval_ty_fun)" and \<Lambda> :: "(var_context)" and \<Gamma> :: "(('a)fun_interp)" and n_s :: "(('a)nstate)" and vc_x :: "int" and vc_y :: "int" and vc_x_0 :: "int" and vc_y_0 :: "int" and vc_y_1 :: "int" and vc_y_2 :: "int" and vc_x_1 :: "int"
assumes 
...
G5: "((lookup_var \<Lambda> n_s 5) = (Some (IntV vc_y_2)))" and 
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> nested_loop_passive_prog.block_2 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon5_LoopBody vc_y_1 vc_y_2) \<Longrightarrow> (s' = Magic)))"
unfolding nested_loop_passive_prog.block_2_def vc.vc_anon5_LoopBody_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> nested_loop_passive_prog.block_3 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon3 vc_x_1 vc_x_0) \<Longrightarrow> (s' = Magic)))"
unfolding nested_loop_passive_prog.block_3_def vc.vc_anon3_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> nested_loop_passive_prog.block_4 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon5_LoopDone vc_y_1 vc_x_1 vc_x_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon3 vc_x_1 vc_x_0)))))))"
unfolding nested_loop_passive_prog.block_4_def vc.vc_anon5_LoopDone_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> nested_loop_passive_prog.block_6 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon4_LoopBody vc_x_0 vc_y_0 vc_y_1 vc_x_1 vc_y_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon5_LoopHead vc_y_1 vc_x_1 vc_x_0 vc_y_2)))))))"
unfolding nested_loop_passive_prog.block_6_def vc.vc_anon4_LoopBody_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> nested_loop_passive_prog.block_8 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 vc_x_0 vc_y_0 vc_y_1 vc_x_1 vc_y_2) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon4_LoopHead vc_x_0 vc_y_0 vc_y_1 vc_x_1 vc_y_2)))))))"
unfolding nested_loop_passive_prog.block_8_def vc.vc_anon0_def
...
lemma block_0:
assumes 
"(red_cmd_list A M \<Lambda> \<Gamma> \<Omega> nested_loop_passive_prog.block_9 (Normal n_s) s')" and 
...
assumes 
"(red_cfg_multi A M \<Lambda> \<Gamma> \<Omega> nested_loop_passive_prog.proc_body ((Inl 10),(Normal n_s)) (m',s'))" and 
"(vc.vc_PreconditionGeneratedEntry vc_x_0 vc_y_0 vc_y_1 vc_x_1 vc_y_2)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step[OF assms(1) nested_loop_passive_prog.node_10])
apply (erule block_PreconditionGeneratedEntry[OF _ assms(2)])
apply ((simp add:nested_loop_passive_prog.outEdges_10))
apply (erule member_elim, simp)
...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append nested_loop_before_ast_to_cfg_prog.constants_vdecls nested_loop_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop_passive_prog.params_vdecls nested_loop_passive_prog.locals_vdecls)) \<Gamma> [] nested_loop_passive_prog.proc_body ((Inl 10),(Normal n_s)) (m',s'))" and 
...
Axioms: "(axiom_assm A \<Gamma> nested_loop_before_ast_to_cfg_prog.constants_vdecls (n_s::(('a)nstate)) nested_loop_before_ast_to_cfg_prog.axioms)" and 
...
ConstsGlobal: "(state_typ_wf A [] (global_state n_s) (append nested_loop_before_ast_to_cfg_prog.constants_vdecls nested_loop_before_ast_to_cfg_prog.globals_vdecls))"
shows "(s' \<noteq> Failure)"
proof -
let ?n_s_c = "(nstate_global_restriction n_s nested_loop_before_ast_to_cfg_prog.constants_vdecls)"
let ?\<Lambda> = "((append nested_loop_before_ast_to_cfg_prog.constants_vdecls nested_loop_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop_passive_prog.params_vdecls nested_loop_passive_prog.locals_vdecls))"
let ?\<Lambda>c = "((nested_loop_before_ast_to_cfg_prog.constants_vdecls,[])::(var_context))"
