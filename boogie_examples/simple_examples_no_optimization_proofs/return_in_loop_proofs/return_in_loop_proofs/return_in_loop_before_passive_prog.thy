theory return_in_loop_before_passive_prog
...
definition block_2
  where
    "block_2  = [(Assume (BinOp (Var 0) Lt (Lit (LInt 0)))),(Assign 0 (BinOp (Var 0) Add (Lit (LInt 1))))]"
definition block_3
  where
    "block_3  = [(Assign 0 (Lit (LInt 0))),(Assert (BinOp (Var 0) Eq (Lit (LInt 0))))]"
definition block_4
  where
