...
definition bigblock_0
  where
    "bigblock_0  = (BigBlock (None ) [(Assign 0 (Lit (LInt 0))),(Assume (BinOp (Var 1) Gt (Lit (LInt 0))))] (Some (WhileWrapper (ParsedWhile (Some (BinOp (Var 0) Lt (Var 1))) [(BinOp (Var 0) Le (Var 1))] [(BigBlock (None ) [(Assign 0 (BinOp (Var 0) Add (Lit (LInt 1))))] (None ) (None ))]))) (None ))"
definition bigblock_1
  where
    "bigblock_1  = (BigBlock (None ) [] (Some (ParsedWhile (Some (BinOp (Var 0) Lt (Var 1))) [(BinOp (Var 0) Le (Var 1))] [(BigBlock (None ) [(Assign 0 (BinOp (Var 0) Add (Lit (LInt 1))))] (None ) (None ))])) (None ))"
definition bigblock_2
  where
    "bigblock_2  = (BigBlock (None ) [(Assign 0 (BinOp (Var 0) Add (Lit (LInt 1))))] (None ) (None ))"
definition bigblock_3
  where
    "bigblock_3  = (BigBlock (None ) [(Assert (BinOp (Var 0) Ge (Var 1)))] (None ) (None ))"
definition cont_3
  where
    "cont_3  = KStop"
definition cont_0
