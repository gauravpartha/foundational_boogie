...
unfolding M_before_cfg_to_dag_prog.block_10_def M_before_passive_prog.block_1_def
...
apply (rule DagAssms)
apply (erule block_anon7_LoopDone)
apply assumption+
apply (rule M_before_cfg_to_dag_prog.outEdges_10)
...
IH_anon8_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body [0] [] M_before_ast_to_cfg_prog.post ns1 s' 3 m' j)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_9_def M_before_passive_prog.block_3_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
IH_anon7_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body [0,1] [] M_before_ast_to_cfg_prog.post ns1 s' 1 m' j)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
apply (rule cfg_dag_helper_2[OF Red _ _ DagVerifies DagAssms])
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_7_def M_before_passive_prog.block_4_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
apply (assumption+)
apply (rule block_anon9_Then)
apply (assumption+)
apply (rule Mods_anon9_Then)
...
apply (assumption+)
apply (rule block_anon9_Else)
apply (assumption+)
apply (rule Mods_anon9_Else)
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_6_def M_before_passive_prog.block_6_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
apply ((simp add:member_rec(1)))
apply (rule cfg_block_anon9_Then)
apply simp
unfolding dag_lemma_assms_def
apply (intro conjI)
apply simp
...
apply ((simp add:M_before_passive_prog.outEdges_6))
apply ((simp add:member_rec(1)))
apply (rule cfg_block_anon9_Else)
apply simp
unfolding dag_lemma_assms_def
apply (intro conjI)
apply simp
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_5_def M_before_passive_prog.block_7_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_3_def M_before_passive_prog.block_8_def
apply cfg_dag_rel_tac_single+
apply simp
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_2_def M_before_passive_prog.block_9_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
DagAssms: "(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)" and 
DagVerifies: "(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 9),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))" and 
IH_anon7_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body [0,1] [] M_before_ast_to_cfg_prog.post ns1 s' 1 m' j)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
apply (rule cfg_dag_helper_2[OF Red _ _ DagVerifies DagAssms])
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_1_def M_before_passive_prog.block_10_def
apply cfg_dag_rel_tac_single+
apply simp
apply ((simp add:M_before_ast_to_cfg_prog.l_x(1)))
...
using assms
apply (rule dag_rel_block_lemma_compact, simp)
unfolding M_before_cfg_to_dag_prog.block_0_def M_before_passive_prog.block_11_def
apply cfg_dag_rel_tac_single+
apply simp
apply simp
done
...
lemma cfg_block_0:
assumes 
"(\<forall> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 12),(Normal ns2)) (m2',s2')) \<longrightarrow> (s2' \<noteq> Failure)))" and 
"(nstate_same_on \<Lambda>1 ns1 ns2 {})" and 
"(state_well_typed A \<Lambda>1 [] ns1)" and 
"(state_well_typed A \<Lambda>1 [] ns2)" and 
"((\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 11),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure))) \<Longrightarrow> R)"
shows "R"
using assms
apply (rule cfg_dag_empty_propagate_helper)
apply (assumption, simp)
apply ((simp add:M_before_passive_prog.outEdges_12))
by ((simp add:M_before_passive_prog.node_12 M_before_passive_prog.block_12_def))
...
"(\<And> m2' s2'. ((red_cfg_multi A M \<Lambda>1 \<Gamma> [] M_before_passive_prog.proc_body ((Inl 13),(Normal ns2)) (m2',s2')) \<Longrightarrow> (s2' \<noteq> Failure)))" and 
"(expr_all_sat A \<Lambda>1 \<Gamma> [] ns2 M_before_ast_to_cfg_prog.pres)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
apply (rule cfg_dag_helper_entry)
apply (rule M_before_passive_prog.node_13)
apply (erule assms(3))
apply (rule assms(2))
unfolding M_before_passive_prog.block_13_def
...
apply ((simp add:M_before_passive_prog.node_12 M_before_passive_prog.block_12_def))
