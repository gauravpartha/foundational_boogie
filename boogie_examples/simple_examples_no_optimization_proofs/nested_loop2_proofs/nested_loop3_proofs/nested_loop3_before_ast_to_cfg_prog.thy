...
definition bigblock_4
  where
    "bigblock_4  = (BigBlock (None ) [] (Some (WhileWrapper (ParsedWhile (Some (BinOp (Var 1) Gt (Lit (LInt 0)))) [(BinOp (Var 1) Ge (Lit (LInt 0)))] [(BigBlock (None ) [(Assign 2 (BinOp (Var 2) Sub (Lit (LInt 1)))),(Assign 1 (BinOp (Var 1) Sub (Lit (LInt 1))))] (None ) (None ))]))) (None ))"
definition bigblock_5
  where
    "bigblock_5  = (BigBlock (None ) [] (Some (ParsedWhile (Some (BinOp (Var 1) Gt (Lit (LInt 0)))) [(BinOp (Var 1) Ge (Lit (LInt 0)))] [(BigBlock (None ) [(Assign 2 (BinOp (Var 2) Sub (Lit (LInt 1)))),(Assign 1 (BinOp (Var 1) Sub (Lit (LInt 1))))] (None ) (None ))])) (None ))"
definition bigblock_6
  where
    "bigblock_6  = (BigBlock (None ) [(Assign 2 (BinOp (Var 2) Sub (Lit (LInt 1)))),(Assign 1 (BinOp (Var 1) Sub (Lit (LInt 1))))] (None ) (None ))"
...
shows "(((map fst (append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls)) \<noteq> []) \<longrightarrow> ((Max (set (map fst (append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls)))) \<le> 0))"
...
lemma globals_max:
shows "(\<forall> x. ((Set.member x (set (map fst (append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls)))) \<longrightarrow> (x \<le> 0)))"
...
lemma consts_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop3_before_ast_to_cfg_prog.constants_vdecls) )"
unfolding nested_loop3_before_ast_to_cfg_prog.constants_vdecls_def
by simp

lemma globals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop3_before_ast_to_cfg_prog.globals_vdecls) )"
unfolding nested_loop3_before_ast_to_cfg_prog.globals_vdecls_def
by simp

lemma params_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop3_before_ast_to_cfg_prog.params_vdecls) )"
unfolding nested_loop3_before_ast_to_cfg_prog.params_vdecls_def
by simp

lemma locals_wf:
shows "((list_all (comp (wf_ty 0) (comp fst snd)) nested_loop3_before_ast_to_cfg_prog.locals_vdecls) )"
unfolding nested_loop3_before_ast_to_cfg_prog.locals_vdecls_def
by simp

lemma var_context_wf:
shows "(\<forall> x \<tau>. (((lookup_var_ty ((append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls)) x) = (Some \<tau>)) \<longrightarrow> ((wf_ty 0) \<tau>)))"
apply (rule lookup_ty_pred_2)
by ((simp_all add:consts_wf globals_wf params_wf locals_wf))

lemma m_x:
shows "((map_of (append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls) 0) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_y:
shows "((map_of (append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls) 1) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_z:
shows "((map_of (append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls) 2) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma l_x:
shows "((lookup_var_decl ((append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls)) 0) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls)) 0) = (Some (TPrim TInt)))"
using globals_locals_disj m_x
by (simp_all add: lookup_var_decl_global_2 lookup_var_decl_local lookup_var_decl_ty_Some)

lemma l_y:
shows "((lookup_var_decl ((append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls)) 1) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls)) 1) = (Some (TPrim TInt)))"
using globals_locals_disj m_y
by (simp_all add: lookup_var_decl_global_2 lookup_var_decl_local lookup_var_decl_ty_Some)

lemma l_z:
shows "((lookup_var_decl ((append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls)) 2) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append nested_loop3_before_ast_to_cfg_prog.constants_vdecls nested_loop3_before_ast_to_cfg_prog.globals_vdecls),(append nested_loop3_before_ast_to_cfg_prog.params_vdecls nested_loop3_before_ast_to_cfg_prog.locals_vdecls)) 2) = (Some (TPrim TInt)))"
