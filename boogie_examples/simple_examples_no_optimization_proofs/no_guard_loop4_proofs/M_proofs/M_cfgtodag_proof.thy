...
IH_anon7_LoopHead: "(loop_ih A M \<Lambda>1 \<Gamma> [] M_before_cfg_to_dag_prog.proc_body [0] [] M_before_ast_to_cfg_prog.post ns1 s' 3 m' j)"
shows "(Semantics.valid_configuration A \<Lambda>1 \<Gamma> [] M_before_ast_to_cfg_prog.post m' s')"
...
"(dag_lemma_assms A \<Lambda>1 \<Gamma> [] [] [] ns1 ns2)"
shows "(dag_lemma_conclusion A M \<Lambda>1 \<Gamma> [] [] M_before_passive_prog.block_4 ns2 s' True)"
using assms
apply (rule dag_rel_block_lemma_compact, simp)
