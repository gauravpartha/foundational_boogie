...
shows "((Set.inter (set (map fst (append triangle_before_ast_to_cfg_prog.constants_vdecls triangle_before_ast_to_cfg_prog.globals_vdecls))) (set (map fst (append triangle_passive_prog.params_vdecls triangle_passive_prog.locals_vdecls)))) = {})"
