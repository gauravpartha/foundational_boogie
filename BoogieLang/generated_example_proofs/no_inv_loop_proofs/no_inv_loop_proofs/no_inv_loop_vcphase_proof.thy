...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append global_data.constants_vdecls global_data.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) \<Gamma> [] no_inv_loop_passive_prog.proc_body ((Inl 6),(Normal n_s)) (m',s'))" and 
...
let ?\<Lambda> = "((append global_data.constants_vdecls global_data.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls))"
