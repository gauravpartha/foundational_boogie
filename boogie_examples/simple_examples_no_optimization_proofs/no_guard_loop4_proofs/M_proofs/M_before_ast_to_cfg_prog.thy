...
definition bigblock_2
  where
    "bigblock_2  = (BigBlock (None ) [(Assign 0 (BinOp (BinOp (Var 0) Add (Var 1)) Add (Var 2)))] (Some (WhileWrapper (ParsedWhile (Some (BinOp (Var 1) Gt (Lit (LInt 10)))) [] [(BigBlock (None ) [(Assign 0 (BinOp (Var 0) Mul (Lit (LInt 10))))] (None ) (None ))]))) (None ))"
