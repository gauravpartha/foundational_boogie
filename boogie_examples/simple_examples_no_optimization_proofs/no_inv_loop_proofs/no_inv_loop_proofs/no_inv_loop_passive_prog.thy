theory no_inv_loop_passive_prog
imports Boogie_Lang.Semantics Boogie_Lang.Util no_inv_loop_before_ast_to_cfg_prog
begin
definition block_0
  where
    "block_0  = []"
...
definition block_2
  where
    "block_2  = [(Assume (BinOp (Var 2) Gt (Lit (LInt 0)))),(Assume (BinOp (Var 3) Eq (BinOp (Var 2) Sub (Lit (LInt 1))))),(Assume (Lit (LBool False)))]"
definition block_3
  where
    "block_3  = []"
definition block_4
...
shows "(((map fst (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) \<noteq> []) \<longrightarrow> ((Min (set (map fst (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)))) \<ge> 0))"
unfolding no_inv_loop_passive_prog.params_vdecls_def no_inv_loop_passive_prog.locals_vdecls_def
by simp

lemma locals_min:
shows "(\<forall> x. ((Set.member x (set (map fst (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)))) \<longrightarrow> (x \<ge> 0)))"
using locals_min_aux helper_min
by blast

lemma globals_locals_disj:
shows "((Set.inter (set (map fst (append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls))) (set (map fst (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)))) = {})"
unfolding no_inv_loop_before_ast_to_cfg_prog.constants_vdecls_def no_inv_loop_before_ast_to_cfg_prog.globals_vdecls_def
by simp

lemma m_x:
shows "((map_of (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls) 0) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_x_0:
shows "((map_of (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls) 1) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_x_1:
shows "((map_of (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls) 2) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma m_x_2:
shows "((map_of (append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls) 3) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)

lemma l_x:
shows "((lookup_var_decl ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 0) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 0) = (Some (TPrim TInt)))"
using globals_locals_disj m_x
by (simp_all add: lookup_var_decl_global_2 lookup_var_decl_local lookup_var_decl_ty_Some)

lemma l_x_0:
shows "((lookup_var_decl ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 1) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 1) = (Some (TPrim TInt)))"
using globals_locals_disj m_x_0
by (simp_all add: lookup_var_decl_global_2 lookup_var_decl_local lookup_var_decl_ty_Some)

lemma l_x_1:
shows "((lookup_var_decl ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 2) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 2) = (Some (TPrim TInt)))"
using globals_locals_disj m_x_1
by (simp_all add: lookup_var_decl_global_2 lookup_var_decl_local lookup_var_decl_ty_Some)

lemma l_x_2:
shows "((lookup_var_decl ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 3) = (Some ((TPrim TInt),(None ))))" and "((lookup_var_ty ((append no_inv_loop_before_ast_to_cfg_prog.constants_vdecls no_inv_loop_before_ast_to_cfg_prog.globals_vdecls),(append no_inv_loop_passive_prog.params_vdecls no_inv_loop_passive_prog.locals_vdecls)) 3) = (Some (TPrim TInt)))"
