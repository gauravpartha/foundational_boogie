...
definition block_1
  where
    "block_1  = [(Assume (BinOp (Lit (LInt 10)) Ge (Var 6)))]"
definition block_2
  where
    "block_2  = [(Assume (BinOp (BinOp (Var 11) Sub (Lit (LInt 10))) Gt (Lit (LInt 200)))),(Assume (BinOp (Var 12) Eq (BinOp (Var 5) Add (Lit (LInt 7))))),(Assume (Lit (LBool False)))]"
definition block_3
  where
    "block_3  = [(Assume (BinOp (Lit (LInt 200)) Ge (BinOp (Var 11) Sub (Lit (LInt 10))))),(Assume (Lit (LBool False)))]"
definition block_4
  where
    "block_4  = [(Assume (BinOp (Var 11) Eq (BinOp (BinOp (Var 10) Add (Var 9)) Add (Var 5))))]"
definition block_5
  where
    "block_5  = [(Assume (Lit (LBool False)))]"
definition block_6
  where
    "block_6  = []"
definition block_7
...
definition block_8
  where
    "block_8  = [(Assume (BinOp (Var 6) Gt (Lit (LInt 10)))),(Assume (BinOp (Var 8) Eq (BinOp (Var 7) Mul (Lit (LInt 10)))))]"
definition block_9
  where
    "block_9  = []"
definition block_10
...
definition outEdges
  where
    "outEdges  = [[],[0],[0],[0],[2,3],[0],[5],[6,4],[7],[1,8],[9],[10],[11]]"
...
definition locals_vdecls :: "(vdecls)"
  where
    "locals_vdecls  = [(0,(TPrim TInt),(None )),(1,(TPrim TInt),(None )),(2,(TPrim TInt),(None )),(3,(TPrim TInt),(None )),(4,(TPrim TInt),(None )),(5,(TPrim TInt),(None )),(6,(TPrim TInt),(None )),(7,(TPrim TInt),(None )),(8,(TPrim TInt),(None )),(9,(TPrim TInt),(None )),(10,(TPrim TInt),(None )),(11,(TPrim TInt),(None )),(12,(TPrim TInt),(None ))]"
...
lemma m_y_3:
shows "((map_of (append M_passive_prog.params_vdecls M_passive_prog.locals_vdecls) 12) = (Some ((TPrim TInt),(None ))))"
by (simp add:params_vdecls_def locals_vdecls_def)
