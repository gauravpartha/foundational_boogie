...
lemma rel_p_before_ast_to_cfg_prog_bigblock_3:
assumes 
astStep: "(red_bigblock A M \<Lambda>1 \<Gamma> [] T (p_before_ast_to_cfg_prog.bigblock_3,cont0,(Normal ns1)) (reached_bb,reached_cont,reached_state))" and 
cfgBlockDoesntFail: "(\<And> s2'. ((red_cmd_list A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.block_4 (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
shows "((reached_state \<noteq> Failure) \<and> (\<forall> ns1'. ((reached_state = (Normal ns1')) \<longrightarrow> (red_cmd_list A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.block_4 (Normal ns1) (Normal ns1')))))"
apply (rule block_local_rel_generic)
apply (rule Rel_Main_test[of p_before_ast_to_cfg_prog.bigblock_3])
apply (simp add: p_before_ast_to_cfg_prog.bigblock_3_def p_before_cfg_to_dag_prog.block_4_def)
apply ((simp add: p_before_cfg_to_dag_prog.block_4_def)+)
apply (rule astStep)
apply (rule cfgBlockDoesntFail)
apply ((simp add: p_before_cfg_to_dag_prog.block_4_def p_before_ast_to_cfg_prog.bigblock_3_def)+)
done


lemma global_rel_p_before_ast_to_cfg_prog_bigblock_3:
assumes 
astTrace: "(red_bigblock_k_step A M \<Lambda>1 \<Gamma> [] T (p_before_ast_to_cfg_prog.bigblock_3,cont_3,(Normal ns1)) j (reached_bb,reached_cont,reached_state))" and 
cfgDoesntFail: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.proc_body ((Inl 4),(Normal ns1)) (m',s')) \<Longrightarrow> (s' \<noteq> Failure)))" and 
cfgSatisfiesPosts: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.proc_body ((Inl 4),(Normal ns1)) (m',s')) \<Longrightarrow> ((is_final_config (m',s')) \<Longrightarrow> (\<forall> ns_end. ((s' = (Normal ns_end)) \<longrightarrow> (expr_all_sat A \<Lambda>1 \<Gamma> [] ns_end p_before_ast_to_cfg_prog.post))))))"
...
apply (rule Rel_Main_test[of p_before_ast_to_cfg_prog.bigblock_3])
apply (simp add: p_before_ast_to_cfg_prog.bigblock_3_def)
apply (simp)
apply (rule astTrace)
apply (simp add: p_before_ast_to_cfg_prog.bigblock_3_def)
apply (simp)
...
apply (rule disjI1)
apply (rule p_before_cfg_to_dag_prog.block_4_def)
apply (rule p_before_cfg_to_dag_prog.outEdges_4)
apply (rule cfgDoesntFail)
apply (simp)
apply (rule cfgSatisfiesPosts)
apply ((simp)+)
apply (simp add: p_before_cfg_to_dag_prog.node_4)
apply (rule rel_p_before_ast_to_cfg_prog_bigblock_3)
apply assumption+

done
qed

lemma global_rel_p_before_ast_to_cfg_prog_bigblock_2:
assumes 
astTrace: "(red_bigblock_k_step A M \<Lambda>1 \<Gamma> [] T (p_before_ast_to_cfg_prog.bigblock_2,cont_2,(Normal ns1)) j (reached_bb,reached_cont,reached_state))" and 
cfgDoesntFail: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.proc_body ((Inl 2),(Normal ns1)) (m',s')) \<Longrightarrow> (s' \<noteq> Failure)))" and 
cfgSatisfiesPosts: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.proc_body ((Inl 2),(Normal ns1)) (m',s')) \<Longrightarrow> ((is_final_config (m',s')) \<Longrightarrow> (\<forall> ns_end. ((s' = (Normal ns_end)) \<longrightarrow> (expr_all_sat A \<Lambda>1 \<Gamma> [] ns_end p_before_ast_to_cfg_prog.post))))))" and 
guardHint: "(red_expr A \<Lambda>1 \<Gamma> [] (BinOp (Var 0) Gt (Lit (LInt 0))) ns1 (BoolV True))" and 
inductionHypothesis: "(loop_IH j A M M' \<Lambda>1 \<Gamma> [] T p_before_ast_to_cfg_prog.bigblock_1 cont_1 p_before_cfg_to_dag_prog.proc_body 1 p_before_ast_to_cfg_prog.post reached_bb reached_cont reached_state)"
shows "(Ast.valid_configuration A \<Lambda>1 \<Gamma> [] p_before_ast_to_cfg_prog.post reached_bb reached_cont reached_state)"
proof -
show ?thesis 
apply (rule block_global_rel_generic)
apply (rule Rel_Invs[of p_before_ast_to_cfg_prog.bigblock_2])
apply (simp add: p_before_ast_to_cfg_prog.bigblock_2_def)
...
apply (rule disjI1)
apply (rule conjI)
apply (rule p_before_cfg_to_dag_prog.block_2_def)
apply (rule conjI)
apply (simp)
...
lemma global_rel_p_before_ast_to_cfg_prog_bigblock_1:
assumes 
astTrace: "(red_bigblock_k_step A M \<Lambda>1 \<Gamma> [] T (p_before_ast_to_cfg_prog.bigblock_1,cont_1,(Normal ns1)) j (reached_bb,reached_cont,reached_state))" and 
cfgDoesntFail: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.proc_body ((Inl 1),(Normal ns1)) (m',s')) \<Longrightarrow> (s' \<noteq> Failure)))" and 
cfgSatisfiesPosts: "(\<And> m' s'. ((red_cfg_multi A M' \<Lambda>1 \<Gamma> [] p_before_cfg_to_dag_prog.proc_body ((Inl 1),(Normal ns1)) (m',s')) \<Longrightarrow> ((is_final_config (m',s')) \<Longrightarrow> (\<forall> ns_end. ((s' = (Normal ns_end)) \<longrightarrow> (expr_all_sat A \<Lambda>1 \<Gamma> [] ns_end p_before_ast_to_cfg_prog.post))))))"
shows "(Ast.valid_configuration A \<Lambda>1 \<Gamma> [] p_before_ast_to_cfg_prog.post reached_bb reached_cont reached_state)"
using assms
...
apply (rule Rel_Invs[of p_before_ast_to_cfg_prog.bigblock_1 _ _ _ p_before_cfg_to_dag_prog.block_1])
apply (simp add:p_before_ast_to_cfg_prog.bigblock_1_def p_before_cfg_to_dag_prog.block_1_def)
apply (rule less(2))
apply (rule less(3), simp)
apply (rule less(4), simp)
apply (simp)
apply (simp add:p_before_ast_to_cfg_prog.bigblock_1_def)
apply simp                 
apply (rule block_local_rel_loop_head)
apply (rule Rel_Invs[of p_before_ast_to_cfg_prog.bigblock_1])
apply ((simp add:p_before_ast_to_cfg_prog.bigblock_1_def)+)
...
apply (simp add:member_rec(1))
apply (erule conjE)
apply (rule global_rel_p_before_ast_to_cfg_prog_bigblock_2)
apply (simp add: cont_1_def p_before_ast_to_cfg_prog.bigblock_2_def cont_2_def )
apply ((blast)+)
...
apply (simp)
apply (simp)
apply (rule global_rel_p_before_ast_to_cfg_prog_bigblock_3)
apply (blast)
...
apply (rule astTrace)
apply (rule Rel_Main_test[of p_before_ast_to_cfg_prog.bigblock_0 _ p_before_cfg_to_dag_prog.block_0])
apply (simp add: p_before_ast_to_cfg_prog.bigblock_0_def p_before_cfg_to_dag_prog.block_0_def)
apply (simp add: p_before_ast_to_cfg_prog.bigblock_0_def p_before_cfg_to_dag_prog.block_0_def)
apply (simp add: p_before_ast_to_cfg_prog.bigblock_0_def p_before_cfg_to_dag_prog.block_0_def)
apply (simp add: p_before_cfg_to_dag_prog.block_0_def)
...
apply (simp add: member_rec(1))
apply (rule global_rel_p_before_ast_to_cfg_prog_bigblock_1)
apply (simp add: p_before_ast_to_cfg_prog.bigblock_1_def cont_0_def cont_1_def)
apply blast+
