...
definition vc_anon3_LoopBody
  where
    "vc_anon3_LoopBody  = True"
definition vc_anon2
  where
    "vc_anon2 i_0 n = (i_0 \<ge> n)"
definition vc_anon3_LoopDone
  where
    "vc_anon3_LoopDone n i_0 = ((n \<le> i_0) \<longrightarrow> (vc_anon2 i_0 n))"
definition vc_anon0
  where
    "vc_anon0 n i_0 = ((n > (0::int)) \<longrightarrow> ((vc_anon3_LoopDone n i_0) \<and> (vc_anon3_LoopBody )))"
definition vc_PreconditionGeneratedEntry
  where
    "vc_PreconditionGeneratedEntry n i_0 = (vc_anon0 n i_0)"
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_1 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon3_LoopBody ) \<Longrightarrow> (s' = Magic)))"
unfolding m_passive_prog.block_1_def vc.vc_anon3_LoopBody_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_2 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon2 vc_i_0 vc_n) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> (n_s' = n_s))))))"
unfolding m_passive_prog.block_2_def vc.vc_anon2_def
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_3 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon3_LoopDone vc_n vc_i_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon2 vc_i_0 vc_n)))))))"
unfolding m_passive_prog.block_3_def vc.vc_anon3_LoopDone_def
...
assumes 
"(red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_4 (Normal n_s) s')" and 
"((vc.vc_anon3_LoopDone vc_n vc_i_0) \<and> (vc.vc_anon3_LoopBody ))"
shows "((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon3_LoopDone vc_n vc_i_0) \<and> (vc.vc_anon3_LoopBody ))))))"
using assms
unfolding m_passive_prog.block_4_def
apply cases
by auto
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_5 (Normal n_s) s') \<Longrightarrow> ((vc.vc_anon0 vc_n vc_i_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> ((vc.vc_anon3_LoopDone vc_n vc_i_0) \<and> (vc.vc_anon3_LoopBody ))))))))"
...
"(vc.vc_anon0 vc_n vc_i_0)"
shows "((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon0 vc_n vc_i_0)))))"
using assms
...
shows "((red_cmd_list A M \<Lambda> \<Gamma> \<Omega> m_passive_prog.block_7 (Normal n_s) s') \<Longrightarrow> ((vc.vc_PreconditionGeneratedEntry vc_n vc_i_0) \<Longrightarrow> ((s' \<noteq> Failure) \<and> (\<forall> n_s'. ((s' = (Normal n_s')) \<longrightarrow> ((n_s' = n_s) \<and> (vc.vc_anon0 vc_n vc_i_0)))))))"
apply (erule red_cmd_list.cases)
using global_assms
unfolding m_passive_prog.block_7_def vc.vc_PreconditionGeneratedEntry_def
...
"(vc.vc_anon2 vc_i_0 vc_n)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
apply (rule red_cfg_multi_backwards_step_2[OF assms(1) m_passive_prog.node_2])
apply (erule block_anon2AA0[OF _ assms(2)])
apply ((simp add:m_passive_prog.outEdges_2))
...
apply (erule block_anon3_LoopHead[OF _ assms(2)])
...
"(vc.vc_PreconditionGeneratedEntry vc_n vc_i_0)"
shows "(s' \<noteq> Failure)"
apply (rule converse_rtranclpE2[OF assms(1)], fastforce)
...
lemma end_to_end:
assumes 
Red: "(red_cfg_multi A M ((append m_before_ast_to_cfg_prog.constants_vdecls m_before_ast_to_cfg_prog.globals_vdecls),(append m_passive_prog.params_vdecls m_passive_prog.locals_vdecls)) \<Gamma> [] m_passive_prog.proc_body ((Inl 7),(Normal n_s)) (m',s'))" and 
